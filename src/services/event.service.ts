...
export default class EventService {
  ...
  //   const like = await this.db.like.deleteMany({
  //     where: {
  //       eventId: id,
  //       userId: content.userId,
  //     },
  //   });
  //   return { like: like[0] }; // Assuming you want to return the first like deleted
  // }
  //
  ...
  // }
  //
  // static async deleteCommentOfEvent({
  //   id,
  //   content,
  // }: GqlMutationDeleteCommentOfEventArgs): Promise<GqlDeleteCommentOfEventPayload> {
