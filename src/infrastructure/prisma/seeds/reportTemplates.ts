...
| 活動認定 | [aggregates_by_reason.GRANT.tx_count]件 | [aggregates_by_reason.GRANT.points_sum] [community_context.point_name] |
| 新規参加の歓迎 | [aggregates_by_reason.ONBOARDING.tx_count]件 | [aggregates_by_reason.ONBOARDING.points_sum] [community_context.point_name] |

※ aggregates_by_reason の件数が 0 の場合はその行を省略する。
