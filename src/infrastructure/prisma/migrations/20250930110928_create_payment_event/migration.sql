...
CREATE TABLE "t_payment_events" (
    ...
    CONSTRAINT "t_payment_events_pkey" PRIMARY KEY ("id")
);

-- CreateIndex
CREATE INDEX "t_payment_events_order_id_idx" ON "t_payment_events"("order_id");

-- CreateIndex
CREATE UNIQUE INDEX "t_payment_events_event_id_key" ON "t_payment_events"("event_id");
