...
import IdentityRepository from "@/domains/identity/repository";

export default class IdentityService {
  static async createUserAndIdentity(data: Prisma.UserCreateInput, uid: string, platform: IdentityPlatform) {
