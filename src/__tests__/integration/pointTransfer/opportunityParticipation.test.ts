...
import { OpportunityCategory, ParticipationStatus, PublishStatus, TransactionReason, WalletType } from "@prisma/client";
import { GqlParticipationSetStatusInput } from "@/types/graphql";
...
describe("Point Reward Tests", () => {
    ...
    it("should giver reward successfully", async () => {
        ...
        const createTransactionInput = { to: communityWalletId, toPointChange: communityInitialPoint, reason: TransactionReason.POINT_ISSUED };
