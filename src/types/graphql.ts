...
export type Scalars = {
  ...
  Upload: {
    input: Promise<import("graphql-upload-minimal").FileUpload>;
    output: Promise<import("graphql-upload-minimal").FileUpload>;
  };
};
...
export type GqlResolversUnionTypes<_RefType extends Record<string, unknown>> = ResolversObject<{
  CommunityCreatePayload: Omit<GqlCommunityCreateSuccess, "community"> & {
    community: _RefType["Community"];
  };
  CommunityDeletePayload: GqlCommunityDeleteSuccess;
  CommunityUpdateProfilePayload: Omit<GqlCommunityUpdateProfileSuccess, "community"> & {
    community: _RefType["Community"];
  };
  EvaluationCreatePayload: Omit<GqlEvaluationCreateSuccess, "evaluation"> & {
    evaluation: _RefType["Evaluation"];
  };
  MembershipInvitePayload: Omit<GqlMembershipInviteSuccess, "membership"> & {
    membership: _RefType["Membership"];
  };
  MembershipRemovePayload: GqlMembershipRemoveSuccess;
  MembershipSetInvitationStatusPayload: Omit<
    GqlMembershipSetInvitationStatusSuccess,
    "membership"
  > & {
    membership: _RefType["Membership"];
  };
  MembershipSetRolePayload: Omit<GqlMembershipSetRoleSuccess, "membership"> & {
    membership: _RefType["Membership"];
  };
  MembershipWithdrawPayload: GqlMembershipWithdrawSuccess;
  OpportunityCreatePayload: Omit<GqlOpportunityCreateSuccess, "opportunity"> & {
    opportunity: _RefType["Opportunity"];
  };
  OpportunityDeletePayload: GqlOpportunityDeleteSuccess;
  OpportunitySetPublishStatusPayload: Omit<GqlOpportunitySetPublishStatusSuccess, "opportunity"> & {
    opportunity: _RefType["Opportunity"];
  };
  OpportunitySlotSetHostingStatusPayload: Omit<
    GqlOpportunitySlotSetHostingStatusSuccess,
    "slot"
  > & {
    slot: _RefType["OpportunitySlot"];
  };
  OpportunitySlotsBulkUpdatePayload: Omit<GqlOpportunitySlotsBulkUpdateSuccess, "slots"> & {
    slots: Array<_RefType["OpportunitySlot"]>;
  };
  OpportunityUpdateContentPayload: Omit<GqlOpportunityUpdateContentSuccess, "opportunity"> & {
    opportunity: _RefType["Opportunity"];
  };
  ParticipationCreatePersonalRecordPayload: Omit<
    GqlParticipationCreatePersonalRecordSuccess,
    "participation"
  > & {
    participation: _RefType["Participation"];
  };
  ...
  ReservationCreatePayload: Omit<GqlReservationCreateSuccess, "reservation"> & {
    reservation: _RefType["Reservation"];
  };
  ReservationSetStatusPayload: Omit<GqlReservationSetStatusSuccess, "reservation"> & {
    reservation: _RefType["Reservation"];
  };
  TicketClaimPayload: Omit<GqlTicketClaimSuccess, "tickets"> & {
    tickets: Array<_RefType["Ticket"]>;
  };
  ...
  TransactionDonateSelfPointPayload: Omit<GqlTransactionDonateSelfPointSuccess, "transaction"> & {
    transaction: _RefType["Transaction"];
  };
  TransactionGrantCommunityPointPayload: Omit<
    GqlTransactionGrantCommunityPointSuccess,
    "transaction"
  > & {
    transaction: _RefType["Transaction"];
  };
  TransactionIssueCommunityPointPayload: Omit<
    GqlTransactionIssueCommunityPointSuccess,
    "transaction"
  > & {
    transaction: _RefType["Transaction"];
  };
  UserUpdateProfilePayload: Omit<GqlUserUpdateProfileSuccess, "user"> & {
  ...
  UtilitySetPublishStatusPayload: Omit<GqlUtilitySetPublishStatusSuccess, "utility"> & {
    utility: _RefType["Utility"];
  };
  UtilityUpdateInfoPayload: Omit<GqlUtilityUpdateInfoSuccess, "utility"> & {
    utility: _RefType["Utility"];
  };
}>;
...
export type GqlResolversInterfaceTypes<_RefType extends Record<string, unknown>> = ResolversObject<{
  Edge:
    ...
    | (Omit<GqlCommunityEdge, "node"> & {
    node?: Maybe<_RefType["Community"]>;
  })
    | (Omit<GqlEvaluationEdge, "node"> & {
    node?: Maybe<_RefType["Evaluation"]>;
  })
    | (Omit<GqlEvaluationHistoryEdge, "node"> & {
    node?: Maybe<_RefType["EvaluationHistory"]>;
  })
    | (Omit<GqlMembershipEdge, "node"> & {
    node?: Maybe<_RefType["Membership"]>;
  })
    | (Omit<GqlMembershipHistoryEdge, "node"> & {
    node?: Maybe<_RefType["MembershipHistory"]>;
  })
    | (Omit<GqlOpportunityEdge, "node"> & {
    node?: Maybe<_RefType["Opportunity"]>;
  })
    | (Omit<GqlOpportunitySlotEdge, "node"> & {
    node?: Maybe<_RefType["OpportunitySlot"]>;
  })
    | (Omit<GqlParticipationEdge, "node"> & {
    node?: Maybe<_RefType["Participation"]>;
  })
    | (Omit<GqlParticipationStatusHistoryEdge, "node"> & {
        node?: Maybe<_RefType["ParticipationStatusHistory"]>;
      })
    | (Omit<GqlPlaceEdge, "node"> & { node?: Maybe<_RefType["Place"]> })
    | (Omit<GqlPortfolioEdge, "node"> & {
    node?: Maybe<_RefType["Portfolio"]>;
  })
    | (Omit<GqlReservationEdge, "node"> & {
    node?: Maybe<_RefType["Reservation"]>;
  })
    | (Omit<GqlReservationHistoryEdge, "node"> & {
    node?: Maybe<_RefType["ReservationHistory"]>;
  })
    | (Omit<GqlTicketEdge, "node"> & {
    node?: Maybe<_RefType["Ticket"]>;
  })
    | (Omit<GqlTicketStatusHistoryEdge, "node"> & {
    node?: Maybe<_RefType["TicketStatusHistory"]>;
  })
    | (Omit<GqlTransactionEdge, "node"> & { node?: Maybe<_RefType["Transaction"]> })
    | (Omit<GqlUserEdge, "node"> & {
    node?: Maybe<_RefType["User"]>;
  })
    | (Omit<GqlUtilityEdge, "node"> & { node?: Maybe<_RefType["Utility"]> })
    | (Omit<GqlWalletEdge, "node"> & {
    node?: Maybe<_RefType["Wallet"]>;
  });
}>;
...
export type GqlResolversTypes = ResolversObject<{
  ...
  ArticleEdge: ResolverTypeWrapper<
    Omit<GqlArticleEdge, "node"> & { node?: Maybe<GqlResolversTypes["Article"]> }
  >;
  ArticleFilterInput: GqlArticleFilterInput;
  ArticleSortInput: GqlArticleSortInput;
  ArticlesConnection: ResolverTypeWrapper<
    Omit<GqlArticlesConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["ArticleEdge"]>>>;
    }
  >;
  ...
  CommunitiesConnection: ResolverTypeWrapper<
    Omit<GqlCommunitiesConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["CommunityEdge"]>>>;
    }
  >;
  Community: ResolverTypeWrapper<Community>;
  CommunityCreateInput: GqlCommunityCreateInput;
  CommunityCreatePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["CommunityCreatePayload"]
  >;
  CommunityCreateSuccess: ResolverTypeWrapper<
    Omit<GqlCommunityCreateSuccess, "community"> & {
    community: GqlResolversTypes["Community"];
  }
  >;
  CommunityDeletePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["CommunityDeletePayload"]
  >;
  CommunityDeleteSuccess: ResolverTypeWrapper<GqlCommunityDeleteSuccess>;
  CommunityEdge: ResolverTypeWrapper<
    Omit<GqlCommunityEdge, "node"> & { node?: Maybe<GqlResolversTypes["Community"]> }
  >;
  ...
  CommunityUpdateProfilePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["CommunityUpdateProfilePayload"]
  >;
  CommunityUpdateProfileSuccess: ResolverTypeWrapper<
    Omit<GqlCommunityUpdateProfileSuccess, "community"> & {
      community: GqlResolversTypes["Community"];
    }
  >;
  CurrentPointView: ResolverTypeWrapper<CurrentPointView>;
  CurrentPrefecture: GqlCurrentPrefecture;
  CurrentUserPayload: ResolverTypeWrapper<
    Omit<GqlCurrentUserPayload, "user"> & {
    user?: Maybe<GqlResolversTypes["User"]>;
  }
  >;
  Datetime: ResolverTypeWrapper<Scalars["Datetime"]["output"]>;
  Decimal: ResolverTypeWrapper<Scalars["Decimal"]["output"]>;
  EarliestReservableSlotView: ResolverTypeWrapper<GqlEarliestReservableSlotView>;
  Edge: ResolverTypeWrapper<GqlResolversInterfaceTypes<GqlResolversTypes>["Edge"]>;
  Evaluation: ResolverTypeWrapper<
    Omit<GqlEvaluation, "evaluator" | "histories" | "participation"> & {
      evaluator: GqlResolversTypes["User"];
      histories?: Maybe<GqlResolversTypes["EvaluationHistoriesConnection"]>;
      participation: GqlResolversTypes["Participation"];
    }
  >;
  EvaluationCreateInput: GqlEvaluationCreateInput;
  EvaluationCreatePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["EvaluationCreatePayload"]
  >;
  EvaluationCreateSuccess: ResolverTypeWrapper<
    Omit<GqlEvaluationCreateSuccess, "evaluation"> & {
    evaluation: GqlResolversTypes["Evaluation"];
  }
  >;
  EvaluationEdge: ResolverTypeWrapper<
    Omit<GqlEvaluationEdge, "node"> & {
    node?: Maybe<GqlResolversTypes["Evaluation"]>;
  }
  >;
  EvaluationFilterInput: GqlEvaluationFilterInput;
  EvaluationHistoriesConnection: ResolverTypeWrapper<
    Omit<GqlEvaluationHistoriesConnection, "edges"> & {
      edges: Array<GqlResolversTypes["EvaluationHistoryEdge"]>;
    }
  >;
  EvaluationHistory: ResolverTypeWrapper<
    Omit<GqlEvaluationHistory, "createdByUser" | "evaluation"> & {
      createdByUser?: Maybe<GqlResolversTypes["User"]>;
      evaluation: GqlResolversTypes["Evaluation"];
    }
  >;
  EvaluationHistoryEdge: ResolverTypeWrapper<
    Omit<GqlEvaluationHistoryEdge, "node"> & {
      node?: Maybe<GqlResolversTypes["EvaluationHistory"]>;
    }
  >;
  ...
  EvaluationsConnection: ResolverTypeWrapper<
    Omit<GqlEvaluationsConnection, "edges"> & {
    edges: Array<GqlResolversTypes["EvaluationEdge"]>;
  }
  >;
  ...
  MembershipEdge: ResolverTypeWrapper<
    Omit<GqlMembershipEdge, "node"> & {
    node?: Maybe<GqlResolversTypes["Membership"]>;
  }
  >;
  MembershipFilterInput: GqlMembershipFilterInput;
  MembershipHistoriesConnection: ResolverTypeWrapper<
    Omit<GqlMembershipHistoriesConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["MembershipHistoryEdge"]>>>;
    }
  >;
  MembershipHistory: ResolverTypeWrapper<MembershipHistory>;
  MembershipHistoryEdge: ResolverTypeWrapper<
    Omit<GqlMembershipHistoryEdge, "node"> & {
      node?: Maybe<GqlResolversTypes["MembershipHistory"]>;
    }
  >;
  ...
  MembershipInvitePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["MembershipInvitePayload"]
  >;
  MembershipInviteSuccess: ResolverTypeWrapper<
    Omit<GqlMembershipInviteSuccess, "membership"> & {
    membership: GqlResolversTypes["Membership"];
  }
  >;
  ...
  MembershipRemovePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["MembershipRemovePayload"]
  >;
  ...
  MembershipSetInvitationStatusPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["MembershipSetInvitationStatusPayload"]
  >;
  MembershipSetInvitationStatusSuccess: ResolverTypeWrapper<
    Omit<GqlMembershipSetInvitationStatusSuccess, "membership"> & {
      membership: GqlResolversTypes["Membership"];
    }
  >;
  MembershipSetRoleInput: GqlMembershipSetRoleInput;
  MembershipSetRolePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["MembershipSetRolePayload"]
  >;
  MembershipSetRoleSuccess: ResolverTypeWrapper<
    Omit<GqlMembershipSetRoleSuccess, "membership"> & {
      membership: GqlResolversTypes["Membership"];
    }
  >;
  ...
  MembershipWithdrawPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["MembershipWithdrawPayload"]
  >;
  MembershipWithdrawSuccess: ResolverTypeWrapper<GqlMembershipWithdrawSuccess>;
  MembershipsConnection: ResolverTypeWrapper<
    Omit<GqlMembershipsConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["MembershipEdge"]>>>;
    }
  >;
  ...
  OpportunitiesConnection: ResolverTypeWrapper<
    Omit<GqlOpportunitiesConnection, "edges"> & {
      edges: Array<GqlResolversTypes["OpportunityEdge"]>;
    }
  >;
  ...
  OpportunityCreatePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["OpportunityCreatePayload"]
  >;
  OpportunityCreateSuccess: ResolverTypeWrapper<
    Omit<GqlOpportunityCreateSuccess, "opportunity"> & {
      opportunity: GqlResolversTypes["Opportunity"];
    }
  >;
  OpportunityDeletePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["OpportunityDeletePayload"]
  >;
  OpportunityDeleteSuccess: ResolverTypeWrapper<GqlOpportunityDeleteSuccess>;
  OpportunityEdge: ResolverTypeWrapper<
    Omit<GqlOpportunityEdge, "node"> & {
    node?: Maybe<GqlResolversTypes["Opportunity"]>;
  }
  >;
  OpportunityFilterInput: GqlOpportunityFilterInput;
  OpportunitySetPublishStatusInput: GqlOpportunitySetPublishStatusInput;
  OpportunitySetPublishStatusPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["OpportunitySetPublishStatusPayload"]
  >;
  OpportunitySetPublishStatusSuccess: ResolverTypeWrapper<
    Omit<GqlOpportunitySetPublishStatusSuccess, "opportunity"> & {
      opportunity: GqlResolversTypes["Opportunity"];
    }
  >;
  OpportunitySlot: ResolverTypeWrapper<OpportunitySlot>;
  OpportunitySlotCreateInput: GqlOpportunitySlotCreateInput;
  OpportunitySlotEdge: ResolverTypeWrapper<
    Omit<GqlOpportunitySlotEdge, "node"> & {
    node?: Maybe<GqlResolversTypes["OpportunitySlot"]>;
  }
  >;
  ...
  OpportunitySlotSetHostingStatusPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["OpportunitySlotSetHostingStatusPayload"]
  >;
  OpportunitySlotSetHostingStatusSuccess: ResolverTypeWrapper<
    Omit<GqlOpportunitySlotSetHostingStatusSuccess, "slot"> & {
      slot: GqlResolversTypes["OpportunitySlot"];
    }
  >;
  ...
  OpportunitySlotsBulkUpdatePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["OpportunitySlotsBulkUpdatePayload"]
  >;
  OpportunitySlotsBulkUpdateSuccess: ResolverTypeWrapper<
    Omit<GqlOpportunitySlotsBulkUpdateSuccess, "slots"> & {
      slots: Array<GqlResolversTypes["OpportunitySlot"]>;
    }
  >;
  OpportunitySlotsConnection: ResolverTypeWrapper<
    Omit<GqlOpportunitySlotsConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["OpportunitySlotEdge"]>>>;
    }
  >;
  OpportunitySortInput: GqlOpportunitySortInput;
  OpportunityUpdateContentInput: GqlOpportunityUpdateContentInput;
  OpportunityUpdateContentPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["OpportunityUpdateContentPayload"]
  >;
  OpportunityUpdateContentSuccess: ResolverTypeWrapper<
    Omit<GqlOpportunityUpdateContentSuccess, "opportunity"> & {
      opportunity: GqlResolversTypes["Opportunity"];
    }
  >;
  ...
  ParticipationCreatePersonalRecordPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["ParticipationCreatePersonalRecordPayload"]
  >;
  ParticipationCreatePersonalRecordSuccess: ResolverTypeWrapper<
    Omit<GqlParticipationCreatePersonalRecordSuccess, "participation"> & {
      participation: GqlResolversTypes["Participation"];
    }
  >;
  ParticipationDeletePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["ParticipationDeletePayload"]
  >;
  ParticipationDeleteSuccess: ResolverTypeWrapper<GqlParticipationDeleteSuccess>;
  ParticipationEdge: ResolverTypeWrapper<
    Omit<GqlParticipationEdge, "node"> & {
    node?: Maybe<GqlResolversTypes["Participation"]>;
  }
  >;
  ...
  ParticipationStatusHistoriesConnection: ResolverTypeWrapper<
    Omit<GqlParticipationStatusHistoriesConnection, "edges"> & {
      edges: Array<GqlResolversTypes["ParticipationStatusHistoryEdge"]>;
    }
  >;
  ParticipationStatusHistory: ResolverTypeWrapper<ParticipationStatusHistory>;
  ParticipationStatusHistoryEdge: ResolverTypeWrapper<
    Omit<GqlParticipationStatusHistoryEdge, "node"> & {
      node?: Maybe<GqlResolversTypes["ParticipationStatusHistory"]>;
    }
  >;
  ...
  ParticipationsConnection: ResolverTypeWrapper<
    Omit<GqlParticipationsConnection, "edges"> & {
      edges: Array<GqlResolversTypes["ParticipationEdge"]>;
    }
  >;
  Place: ResolverTypeWrapper<Place>;
  PlaceCreateInput: GqlPlaceCreateInput;
  PlaceCreatePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["PlaceCreatePayload"]
  >;
  PlaceCreateSuccess: ResolverTypeWrapper<
    Omit<GqlPlaceCreateSuccess, "place"> & { place: GqlResolversTypes["Place"] }
  >;
  PlaceDeletePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["PlaceDeletePayload"]
  >;
  PlaceDeleteSuccess: ResolverTypeWrapper<GqlPlaceDeleteSuccess>;
  PlaceEdge: ResolverTypeWrapper<
    Omit<GqlPlaceEdge, "node"> & { node?: Maybe<GqlResolversTypes["Place"]> }
  >;
  PlaceFilterInput: GqlPlaceFilterInput;
  PlaceSortInput: GqlPlaceSortInput;
  PlaceUpdateInput: GqlPlaceUpdateInput;
  PlaceUpdatePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["PlaceUpdatePayload"]
  >;
  PlaceUpdateSuccess: ResolverTypeWrapper<
    Omit<GqlPlaceUpdateSuccess, "place"> & { place: GqlResolversTypes["Place"] }
  >;
  PlacesConnection: ResolverTypeWrapper<
    Omit<GqlPlacesConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["PlaceEdge"]>>>;
    }
  >;
  Portfolio: ResolverTypeWrapper<
    Omit<GqlPortfolio, "participants" | "place"> & {
      participants: Array<GqlResolversTypes["User"]>;
      place?: Maybe<GqlResolversTypes["Place"]>;
    }
  >;
  PortfolioEdge: ResolverTypeWrapper<
    Omit<GqlPortfolioEdge, "node"> & { node?: Maybe<GqlResolversTypes["Portfolio"]> }
  >;
  PortfolioFilterInput: GqlPortfolioFilterInput;
  PortfolioSortInput: GqlPortfolioSortInput;
  PortfolioSource: GqlPortfolioSource;
  PortfoliosConnection: ResolverTypeWrapper<
    Omit<GqlPortfoliosConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["PortfolioEdge"]>>>;
    }
  >;
  PublishStatus: GqlPublishStatus;
  ...
  Reservation: ResolverTypeWrapper<
    Omit<GqlReservation, "createdByUser" | "histories" | "opportunitySlot" | "participations"> & {
      createdByUser?: Maybe<GqlResolversTypes["User"]>;
      histories?: Maybe<Array<GqlResolversTypes["ReservationHistory"]>>;
      opportunitySlot: GqlResolversTypes["OpportunitySlot"];
      participations?: Maybe<Array<GqlResolversTypes["Participation"]>>;
    }
  >;
  ReservationCancelInput: GqlReservationCancelInput;
  ReservationCreateInput: GqlReservationCreateInput;
  ReservationCreatePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["ReservationCreatePayload"]
  >;
  ReservationCreateSuccess: ResolverTypeWrapper<
    Omit<GqlReservationCreateSuccess, "reservation"> & {
      reservation: GqlResolversTypes["Reservation"];
    }
  >;
  ReservationEdge: ResolverTypeWrapper<
    Omit<GqlReservationEdge, "node"> & {
    node?: Maybe<GqlResolversTypes["Reservation"]>;
  }
  >;
  ReservationFilterInput: GqlReservationFilterInput;
  ReservationHistoriesConnection: ResolverTypeWrapper<
    Omit<GqlReservationHistoriesConnection, "edges"> & {
      edges: Array<GqlResolversTypes["ReservationHistoryEdge"]>;
    }
  >;
  ReservationHistory: ResolverTypeWrapper<
    Omit<GqlReservationHistory, "createdByUser" | "reservation"> & {
      createdByUser?: Maybe<GqlResolversTypes["User"]>;
      reservation: GqlResolversTypes["Reservation"];
    }
  >;
  ReservationHistoryEdge: ResolverTypeWrapper<
    Omit<GqlReservationHistoryEdge, "node"> & {
      node?: Maybe<GqlResolversTypes["ReservationHistory"]>;
    }
  >;
  ...
  ReservationSetStatusPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["ReservationSetStatusPayload"]
  >;
  ReservationSetStatusSuccess: ResolverTypeWrapper<
    Omit<GqlReservationSetStatusSuccess, "reservation"> & {
      reservation: GqlResolversTypes["Reservation"];
    }
  >;
  ReservationSortInput: GqlReservationSortInput;
  ReservationStatus: GqlReservationStatus;
  ReservationsConnection: ResolverTypeWrapper<
    Omit<GqlReservationsConnection, "edges"> & {
      edges: Array<GqlResolversTypes["ReservationEdge"]>;
    }
  >;
  Role: GqlRole;
  ...
  >;
  TicketClaimSuccess: ResolverTypeWrapper<
    Omit<GqlTicketClaimSuccess, "tickets"> & {
    tickets: Array<GqlResolversTypes["Ticket"]>;
  }
  >;
  TicketEdge: ResolverTypeWrapper<
    Omit<GqlTicketEdge, "node"> & { node?: Maybe<GqlResolversTypes["Ticket"]> }
  >;
  TicketFilterInput: GqlTicketFilterInput;
  TicketIssueInput: GqlTicketIssueInput;
  TicketIssuePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["TicketIssuePayload"]
  >;
  TicketIssueSuccess: ResolverTypeWrapper<
    Omit<GqlTicketIssueSuccess, "issue"> & {
  ...
  >;
  TicketPurchaseSuccess: ResolverTypeWrapper<
    Omit<GqlTicketPurchaseSuccess, "ticket"> & {
    ticket: GqlResolversTypes["Ticket"];
  }
  >;
  TicketRefundInput: GqlTicketRefundInput;
  TicketRefundPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["TicketRefundPayload"]
  >;
  TicketRefundSuccess: ResolverTypeWrapper<
    Omit<GqlTicketRefundSuccess, "ticket"> & {
    ticket: GqlResolversTypes["Ticket"];
  }
  >;
  TicketSortInput: GqlTicketSortInput;
  TicketStatus: GqlTicketStatus;
  TicketStatusHistoriesConnection: ResolverTypeWrapper<
    Omit<GqlTicketStatusHistoriesConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["TicketStatusHistoryEdge"]>>>;
    }
  >;
  TicketStatusHistory: ResolverTypeWrapper<TicketStatusHistory>;
  TicketStatusHistoryEdge: ResolverTypeWrapper<
    Omit<GqlTicketStatusHistoryEdge, "node"> & {
      node?: Maybe<GqlResolversTypes["TicketStatusHistory"]>;
    }
  >;
  ...
  TicketUsePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["TicketUsePayload"]
  >;
  TicketUseSuccess: ResolverTypeWrapper<
    Omit<GqlTicketUseSuccess, "ticket"> & { ticket: GqlResolversTypes["Ticket"] }
  >;
  TicketsConnection: ResolverTypeWrapper<
    Omit<GqlTicketsConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["TicketEdge"]>>>;
    }
  >;
  Transaction: ResolverTypeWrapper<Transaction>;
  TransactionDonateSelfPointInput: GqlTransactionDonateSelfPointInput;
  TransactionDonateSelfPointPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["TransactionDonateSelfPointPayload"]
  >;
  TransactionDonateSelfPointSuccess: ResolverTypeWrapper<
    Omit<GqlTransactionDonateSelfPointSuccess, "transaction"> & {
      transaction: GqlResolversTypes["Transaction"];
    }
  >;
  TransactionEdge: ResolverTypeWrapper<
    Omit<GqlTransactionEdge, "node"> & {
    node?: Maybe<GqlResolversTypes["Transaction"]>;
  }
  >;
  ...
  TransactionGrantCommunityPointPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["TransactionGrantCommunityPointPayload"]
  >;
  TransactionGrantCommunityPointSuccess: ResolverTypeWrapper<
    Omit<GqlTransactionGrantCommunityPointSuccess, "transaction"> & {
      transaction: GqlResolversTypes["Transaction"];
    }
  >;
  TransactionIssueCommunityPointInput: GqlTransactionIssueCommunityPointInput;
  TransactionIssueCommunityPointPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["TransactionIssueCommunityPointPayload"]
  >;
  TransactionIssueCommunityPointSuccess: ResolverTypeWrapper<
    Omit<GqlTransactionIssueCommunityPointSuccess, "transaction"> & {
      transaction: GqlResolversTypes["Transaction"];
    }
  >;
  TransactionReason: GqlTransactionReason;
  TransactionSortInput: GqlTransactionSortInput;
  TransactionsConnection: ResolverTypeWrapper<
    Omit<GqlTransactionsConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["TransactionEdge"]>>>;
    }
  >;
  ...
  UserUpdateProfilePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["UserUpdateProfilePayload"]
  >;
  UserUpdateProfileSuccess: ResolverTypeWrapper<
    Omit<GqlUserUpdateProfileSuccess, "user"> & {
    user?: Maybe<GqlResolversTypes["User"]>;
  }
  >;
  ...
  >;
  UtilitiesConnection: ResolverTypeWrapper<
    Omit<GqlUtilitiesConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["UtilityEdge"]>>>;
    }
  >;
  Utility: ResolverTypeWrapper<Utility>;
  UtilityCreateInput: GqlUtilityCreateInput;
  UtilityCreatePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["UtilityCreatePayload"]
  >;
  UtilityCreateSuccess: ResolverTypeWrapper<
    Omit<GqlUtilityCreateSuccess, "utility"> & {
    utility: GqlResolversTypes["Utility"];
  }
  >;
  UtilityDeletePayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["UtilityDeletePayload"]
  >;
  UtilityDeleteSuccess: ResolverTypeWrapper<GqlUtilityDeleteSuccess>;
  UtilityEdge: ResolverTypeWrapper<
    Omit<GqlUtilityEdge, "node"> & { node?: Maybe<GqlResolversTypes["Utility"]> }
  >;
  UtilityFilterInput: GqlUtilityFilterInput;
  UtilitySetPublishStatusInput: GqlUtilitySetPublishStatusInput;
  UtilitySetPublishStatusPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["UtilitySetPublishStatusPayload"]
  >;
  UtilitySetPublishStatusSuccess: ResolverTypeWrapper<
    Omit<GqlUtilitySetPublishStatusSuccess, "utility"> & {
    utility: GqlResolversTypes["Utility"];
  }
  >;
  UtilitySortInput: GqlUtilitySortInput;
  UtilityUpdateInfoInput: GqlUtilityUpdateInfoInput;
  UtilityUpdateInfoPayload: ResolverTypeWrapper<
    GqlResolversUnionTypes<GqlResolversTypes>["UtilityUpdateInfoPayload"]
  >;
  UtilityUpdateInfoSuccess: ResolverTypeWrapper<
    Omit<GqlUtilityUpdateInfoSuccess, "utility"> & {
    utility: GqlResolversTypes["Utility"];
  }
  >;
  ValueType: GqlValueType;
  Wallet: ResolverTypeWrapper<Wallet>;
  WalletEdge: ResolverTypeWrapper<
    Omit<GqlWalletEdge, "node"> & { node?: Maybe<GqlResolversTypes["Wallet"]> }
  >;
  WalletFilterInput: GqlWalletFilterInput;
  WalletSortInput: GqlWalletSortInput;
  WalletType: GqlWalletType;
  WalletsConnection: ResolverTypeWrapper<
    Omit<GqlWalletsConnection, "edges"> & {
      edges?: Maybe<Array<Maybe<GqlResolversTypes["WalletEdge"]>>>;
    }
  >;
}>;
...
export type GqlResolversParentTypes = ResolversObject<{
  ...
  ArticleFilterInput: GqlArticleFilterInput;
  ArticleSortInput: GqlArticleSortInput;
  ArticlesConnection: Omit<GqlArticlesConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["ArticleEdge"]>>>;
  };
  AuthZDirectiveCompositeRulesInput: GqlAuthZDirectiveCompositeRulesInput;
  AuthZDirectiveDeepCompositeRulesInput: GqlAuthZDirectiveDeepCompositeRulesInput;
  ...
  CheckOpportunityPermissionInput: GqlCheckOpportunityPermissionInput;
  City: City;
  CommunitiesConnection: Omit<GqlCommunitiesConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["CommunityEdge"]>>>;
  };
  Community: Community;
  CommunityCreateInput: GqlCommunityCreateInput;
  CommunityCreatePayload: GqlResolversUnionTypes<GqlResolversParentTypes>["CommunityCreatePayload"];
  CommunityCreateSuccess: Omit<GqlCommunityCreateSuccess, "community"> & {
    community: GqlResolversParentTypes["Community"];
  };
  ...
  CommunityEdge: Omit<GqlCommunityEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["Community"]>;
  };
  CommunityFilterInput: GqlCommunityFilterInput;
  CommunitySortInput: GqlCommunitySortInput;
  CommunityUpdateProfileInput: GqlCommunityUpdateProfileInput;
  CommunityUpdateProfilePayload: GqlResolversUnionTypes<GqlResolversParentTypes>["CommunityUpdateProfilePayload"];
  CommunityUpdateProfileSuccess: Omit<GqlCommunityUpdateProfileSuccess, "community"> & {
    community: GqlResolversParentTypes["Community"];
  };
  CurrentPointView: CurrentPointView;
  CurrentUserPayload: Omit<GqlCurrentUserPayload, "user"> & {
    user?: Maybe<GqlResolversParentTypes["User"]>;
  };
  Datetime: Scalars["Datetime"]["output"];
  Decimal: Scalars["Decimal"]["output"];
  EarliestReservableSlotView: GqlEarliestReservableSlotView;
  Edge: GqlResolversInterfaceTypes<GqlResolversParentTypes>["Edge"];
  Evaluation: Omit<GqlEvaluation, "evaluator" | "histories" | "participation"> & {
    evaluator: GqlResolversParentTypes["User"];
    histories?: Maybe<GqlResolversParentTypes["EvaluationHistoriesConnection"]>;
    participation: GqlResolversParentTypes["Participation"];
  };
  EvaluationCreateInput: GqlEvaluationCreateInput;
  EvaluationCreatePayload: GqlResolversUnionTypes<GqlResolversParentTypes>["EvaluationCreatePayload"];
  EvaluationCreateSuccess: Omit<GqlEvaluationCreateSuccess, "evaluation"> & {
    evaluation: GqlResolversParentTypes["Evaluation"];
  };
  EvaluationEdge: Omit<GqlEvaluationEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["Evaluation"]>;
  };
  EvaluationFilterInput: GqlEvaluationFilterInput;
  EvaluationHistoriesConnection: Omit<GqlEvaluationHistoriesConnection, "edges"> & {
    edges: Array<GqlResolversParentTypes["EvaluationHistoryEdge"]>;
  };
  EvaluationHistory: Omit<GqlEvaluationHistory, "createdByUser" | "evaluation"> & {
    createdByUser?: Maybe<GqlResolversParentTypes["User"]>;
    evaluation: GqlResolversParentTypes["Evaluation"];
  };
  EvaluationHistoryEdge: Omit<GqlEvaluationHistoryEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["EvaluationHistory"]>;
  };
  EvaluationHistoryFilterInput: GqlEvaluationHistoryFilterInput;
  EvaluationHistorySortInput: GqlEvaluationHistorySortInput;
  EvaluationSortInput: GqlEvaluationSortInput;
  EvaluationsConnection: Omit<GqlEvaluationsConnection, "edges"> & {
    edges: Array<GqlResolversParentTypes["EvaluationEdge"]>;
  };
  ID: Scalars["ID"]["output"];
  ImageInput: GqlImageInput;
  ...
  MembershipCursorInput: GqlMembershipCursorInput;
  MembershipEdge: Omit<GqlMembershipEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["Membership"]>;
  };
  MembershipFilterInput: GqlMembershipFilterInput;
  MembershipHistoriesConnection: Omit<GqlMembershipHistoriesConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["MembershipHistoryEdge"]>>>;
  };
  MembershipHistory: MembershipHistory;
  MembershipHistoryEdge: Omit<GqlMembershipHistoryEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["MembershipHistory"]>;
  };
  MembershipHistoryFilterInput: GqlMembershipHistoryFilterInput;
  MembershipHistorySortInput: GqlMembershipHistorySortInput;
  ...
  MembershipInviteSuccess: Omit<GqlMembershipInviteSuccess, "membership"> & {
    membership: GqlResolversParentTypes["Membership"];
  };
  ...
  MembershipSetInvitationStatusSuccess: Omit<
    GqlMembershipSetInvitationStatusSuccess,
    "membership"
  > & {
    membership: GqlResolversParentTypes["Membership"];
  ...
  MembershipSetRoleSuccess: Omit<GqlMembershipSetRoleSuccess, "membership"> & {
    membership: GqlResolversParentTypes["Membership"];
  };
  MembershipSortInput: GqlMembershipSortInput;
  MembershipWithdrawInput: GqlMembershipWithdrawInput;
  ...
  MembershipsConnection: Omit<GqlMembershipsConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["MembershipEdge"]>>>;
  };
  Mutation: {};
  NestedPlaceConnectOrCreateInput: GqlNestedPlaceConnectOrCreateInput;
  NestedPlaceCreateInput: GqlNestedPlaceCreateInput;
  NestedPlacesBulkConnectOrCreateInput: GqlNestedPlacesBulkConnectOrCreateInput;
  NestedPlacesBulkUpdateInput: GqlNestedPlacesBulkUpdateInput;
  OpportunitiesConnection: Omit<GqlOpportunitiesConnection, "edges"> & {
    edges: Array<GqlResolversParentTypes["OpportunityEdge"]>;
  };
  Opportunity: Opportunity;
  OpportunityCreateInput: GqlOpportunityCreateInput;
  OpportunityCreatePayload: GqlResolversUnionTypes<GqlResolversParentTypes>["OpportunityCreatePayload"];
  OpportunityCreateSuccess: Omit<GqlOpportunityCreateSuccess, "opportunity"> & {
    opportunity: GqlResolversParentTypes["Opportunity"];
  };
  ...
  OpportunityEdge: Omit<GqlOpportunityEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["Opportunity"]>;
  };
  OpportunityFilterInput: GqlOpportunityFilterInput;
  OpportunitySetPublishStatusInput: GqlOpportunitySetPublishStatusInput;
  OpportunitySetPublishStatusPayload: GqlResolversUnionTypes<GqlResolversParentTypes>["OpportunitySetPublishStatusPayload"];
  OpportunitySetPublishStatusSuccess: Omit<GqlOpportunitySetPublishStatusSuccess, "opportunity"> & {
    opportunity: GqlResolversParentTypes["Opportunity"];
  };
  OpportunitySlot: OpportunitySlot;
  OpportunitySlotCreateInput: GqlOpportunitySlotCreateInput;
  OpportunitySlotEdge: Omit<GqlOpportunitySlotEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["OpportunitySlot"]>;
  };
  OpportunitySlotFilterInput: GqlOpportunitySlotFilterInput;
  OpportunitySlotSetHostingStatusInput: GqlOpportunitySlotSetHostingStatusInput;
  ...
  OpportunitySlotSetHostingStatusSuccess: Omit<
    GqlOpportunitySlotSetHostingStatusSuccess,
    "slot"
  > & {
    slot: GqlResolversParentTypes["OpportunitySlot"];
  };
  OpportunitySlotSortInput: GqlOpportunitySlotSortInput;
  OpportunitySlotUpdateInput: GqlOpportunitySlotUpdateInput;
  OpportunitySlotsBulkUpdateInput: GqlOpportunitySlotsBulkUpdateInput;
  OpportunitySlotsBulkUpdatePayload: GqlResolversUnionTypes<GqlResolversParentTypes>["OpportunitySlotsBulkUpdatePayload"];
  OpportunitySlotsBulkUpdateSuccess: Omit<GqlOpportunitySlotsBulkUpdateSuccess, "slots"> & {
    slots: Array<GqlResolversParentTypes["OpportunitySlot"]>;
  };
  OpportunitySlotsConnection: Omit<GqlOpportunitySlotsConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["OpportunitySlotEdge"]>>>;
  };
  OpportunitySortInput: GqlOpportunitySortInput;
  OpportunityUpdateContentInput: GqlOpportunityUpdateContentInput;
  OpportunityUpdateContentPayload: GqlResolversUnionTypes<GqlResolversParentTypes>["OpportunityUpdateContentPayload"];
  OpportunityUpdateContentSuccess: Omit<GqlOpportunityUpdateContentSuccess, "opportunity"> & {
    opportunity: GqlResolversParentTypes["Opportunity"];
  };
  PageInfo: GqlPageInfo;
  Paging: GqlPaging;
  ...
  ParticipationCreatePersonalRecordSuccess: Omit<
    GqlParticipationCreatePersonalRecordSuccess,
    "participation"
  > & {
    participation: GqlResolversParentTypes["Participation"];
  ...
  ParticipationEdge: Omit<GqlParticipationEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["Participation"]>;
  };
  ParticipationFilterInput: GqlParticipationFilterInput;
  ParticipationSortInput: GqlParticipationSortInput;
  ParticipationStatusHistoriesConnection: Omit<
    GqlParticipationStatusHistoriesConnection,
    "edges"
  > & {
    edges: Array<GqlResolversParentTypes["ParticipationStatusHistoryEdge"]>;
  };
  ParticipationStatusHistory: ParticipationStatusHistory;
  ParticipationStatusHistoryEdge: Omit<GqlParticipationStatusHistoryEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["ParticipationStatusHistory"]>;
  };
  ParticipationStatusHistoryFilterInput: GqlParticipationStatusHistoryFilterInput;
  ParticipationStatusHistorySortInput: GqlParticipationStatusHistorySortInput;
  ParticipationsConnection: Omit<GqlParticipationsConnection, "edges"> & {
    edges: Array<GqlResolversParentTypes["ParticipationEdge"]>;
  };
  Place: Place;
  PlaceCreateInput: GqlPlaceCreateInput;
  PlaceCreatePayload: GqlResolversUnionTypes<GqlResolversParentTypes>["PlaceCreatePayload"];
  PlaceCreateSuccess: Omit<GqlPlaceCreateSuccess, "place"> & {
    place: GqlResolversParentTypes["Place"];
  };
  ...
  PlaceUpdateSuccess: Omit<GqlPlaceUpdateSuccess, "place"> & {
    place: GqlResolversParentTypes["Place"];
  };
  PlacesConnection: Omit<GqlPlacesConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["PlaceEdge"]>>>;
  };
  Portfolio: Omit<GqlPortfolio, "participants" | "place"> & {
    participants: Array<GqlResolversParentTypes["User"]>;
    place?: Maybe<GqlResolversParentTypes["Place"]>;
  };
  PortfolioEdge: Omit<GqlPortfolioEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["Portfolio"]>;
  };
  PortfolioFilterInput: GqlPortfolioFilterInput;
  PortfolioSortInput: GqlPortfolioSortInput;
  PortfoliosConnection: Omit<GqlPortfoliosConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["PortfolioEdge"]>>>;
  };
  Query: {};
  RemainingCapacityView: GqlRemainingCapacityView;
  Reservation: Omit<
    GqlReservation,
    "createdByUser" | "histories" | "opportunitySlot" | "participations"
  > & {
    createdByUser?: Maybe<GqlResolversParentTypes["User"]>;
    histories?: Maybe<Array<GqlResolversParentTypes["ReservationHistory"]>>;
    opportunitySlot: GqlResolversParentTypes["OpportunitySlot"];
  ...
  ReservationCreateSuccess: Omit<GqlReservationCreateSuccess, "reservation"> & {
    reservation: GqlResolversParentTypes["Reservation"];
  };
  ReservationEdge: Omit<GqlReservationEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["Reservation"]>;
  };
  ReservationFilterInput: GqlReservationFilterInput;
  ReservationHistoriesConnection: Omit<GqlReservationHistoriesConnection, "edges"> & {
    edges: Array<GqlResolversParentTypes["ReservationHistoryEdge"]>;
  };
  ReservationHistory: Omit<GqlReservationHistory, "createdByUser" | "reservation"> & {
    createdByUser?: Maybe<GqlResolversParentTypes["User"]>;
    reservation: GqlResolversParentTypes["Reservation"];
  };
  ReservationHistoryEdge: Omit<GqlReservationHistoryEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["ReservationHistory"]>;
  };
  ReservationHistoryFilterInput: GqlReservationHistoryFilterInput;
  ReservationHistorySortInput: GqlReservationHistorySortInput;
  ReservationSetStatusPayload: GqlResolversUnionTypes<GqlResolversParentTypes>["ReservationSetStatusPayload"];
  ReservationSetStatusSuccess: Omit<GqlReservationSetStatusSuccess, "reservation"> & {
    reservation: GqlResolversParentTypes["Reservation"];
  };
  ReservationSortInput: GqlReservationSortInput;
  ReservationsConnection: Omit<GqlReservationsConnection, "edges"> & {
    edges: Array<GqlResolversParentTypes["ReservationEdge"]>;
  };
  State: State;
  ...
  TicketPurchaseSuccess: Omit<GqlTicketPurchaseSuccess, "ticket"> & {
    ticket: GqlResolversParentTypes["Ticket"];
  };
  TicketRefundInput: GqlTicketRefundInput;
  TicketRefundPayload: GqlResolversUnionTypes<GqlResolversParentTypes>["TicketRefundPayload"];
  TicketRefundSuccess: Omit<GqlTicketRefundSuccess, "ticket"> & {
    ticket: GqlResolversParentTypes["Ticket"];
  };
  TicketSortInput: GqlTicketSortInput;
  TicketStatusHistoriesConnection: Omit<GqlTicketStatusHistoriesConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["TicketStatusHistoryEdge"]>>>;
  };
  TicketStatusHistory: TicketStatusHistory;
  TicketStatusHistoryEdge: Omit<GqlTicketStatusHistoryEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["TicketStatusHistory"]>;
  };
  TicketStatusHistoryFilterInput: GqlTicketStatusHistoryFilterInput;
  TicketStatusHistorySortInput: GqlTicketStatusHistorySortInput;
  TicketUsePayload: GqlResolversUnionTypes<GqlResolversParentTypes>["TicketUsePayload"];
  TicketUseSuccess: Omit<GqlTicketUseSuccess, "ticket"> & {
    ticket: GqlResolversParentTypes["Ticket"];
  };
  TicketsConnection: Omit<GqlTicketsConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["TicketEdge"]>>>;
  };
  Transaction: Transaction;
  TransactionDonateSelfPointInput: GqlTransactionDonateSelfPointInput;
  TransactionDonateSelfPointPayload: GqlResolversUnionTypes<GqlResolversParentTypes>["TransactionDonateSelfPointPayload"];
  TransactionDonateSelfPointSuccess: Omit<GqlTransactionDonateSelfPointSuccess, "transaction"> & {
    transaction: GqlResolversParentTypes["Transaction"];
  };
  TransactionEdge: Omit<GqlTransactionEdge, "node"> & {
    node?: Maybe<GqlResolversParentTypes["Transaction"]>;
  };
  TransactionFilterInput: GqlTransactionFilterInput;
  TransactionGrantCommunityPointInput: GqlTransactionGrantCommunityPointInput;
  ...
  TransactionGrantCommunityPointSuccess: Omit<
    GqlTransactionGrantCommunityPointSuccess,
    "transaction"
  > & {
    transaction: GqlResolversParentTypes["Transaction"];
  ...
  TransactionIssueCommunityPointSuccess: Omit<
    GqlTransactionIssueCommunityPointSuccess,
    "transaction"
  > & {
    transaction: GqlResolversParentTypes["Transaction"];
  ...
  TransactionSortInput: GqlTransactionSortInput;
  TransactionsConnection: Omit<GqlTransactionsConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["TransactionEdge"]>>>;
  };
  ...
  UserUpdateProfileSuccess: Omit<GqlUserUpdateProfileSuccess, "user"> & {
    user?: Maybe<GqlResolversParentTypes["User"]>;
  };
  UsersConnection: Omit<GqlUsersConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["UserEdge"]>>>;
  };
  UtilitiesConnection: Omit<GqlUtilitiesConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["UtilityEdge"]>>>;
  };
  Utility: Utility;
  UtilityCreateInput: GqlUtilityCreateInput;
  UtilityCreatePayload: GqlResolversUnionTypes<GqlResolversParentTypes>["UtilityCreatePayload"];
  UtilityCreateSuccess: Omit<GqlUtilityCreateSuccess, "utility"> & {
    utility: GqlResolversParentTypes["Utility"];
  };
  ...
  UtilitySetPublishStatusSuccess: Omit<GqlUtilitySetPublishStatusSuccess, "utility"> & {
    utility: GqlResolversParentTypes["Utility"];
  };
  UtilitySortInput: GqlUtilitySortInput;
  UtilityUpdateInfoInput: GqlUtilityUpdateInfoInput;
  UtilityUpdateInfoPayload: GqlResolversUnionTypes<GqlResolversParentTypes>["UtilityUpdateInfoPayload"];
  UtilityUpdateInfoSuccess: Omit<GqlUtilityUpdateInfoSuccess, "utility"> & {
    utility: GqlResolversParentTypes["Utility"];
  };
  Wallet: Wallet;
  ...
  WalletFilterInput: GqlWalletFilterInput;
  WalletSortInput: GqlWalletSortInput;
  WalletsConnection: Omit<GqlWalletsConnection, "edges"> & {
    edges?: Maybe<Array<Maybe<GqlResolversParentTypes["WalletEdge"]>>>;
  };
}>;
...
export type GqlAuthzDirectiveResolver<
  Result,
  Parent,
  ContextType = any,
  Args = GqlAuthzDirectiveArgs,
...
export type GqlRequireRoleDirectiveResolver<
  Result,
  Parent,
  ContextType = any,
  Args = GqlRequireRoleDirectiveArgs,
> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type GqlAccumulatedPointViewResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["AccumulatedPointView"] = GqlResolversParentTypes["AccumulatedPointView"],
> = ResolversObject<{
...
export type GqlArticleEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ArticleEdge"] = GqlResolversParentTypes["ArticleEdge"],
> = ResolversObject<{
...
export type GqlArticlesConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ArticlesConnection"] = GqlResolversParentTypes["ArticlesConnection"],
> = ResolversObject<{
...
export type GqlCommunitiesConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["CommunitiesConnection"] = GqlResolversParentTypes["CommunitiesConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<Maybe<GqlResolversTypes["CommunityEdge"]>>>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<GqlResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type GqlCommunityResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["Community"] = GqlResolversParentTypes["Community"],
> = ResolversObject<{
  articles?: Resolver<
    Maybe<GqlResolversTypes["ArticlesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlCommunityArticlesArgs>
  >;
  ...
  memberships?: Resolver<
    Maybe<GqlResolversTypes["MembershipsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlCommunityMembershipsArgs>
  >;
  name?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
  opportunities?: Resolver<
    Maybe<GqlResolversTypes["OpportunitiesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlCommunityOpportunitiesArgs>
  >;
  participations?: Resolver<
    Maybe<GqlResolversTypes["ParticipationsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlCommunityParticipationsArgs>
  >;
  ...
  updatedAt?: Resolver<Maybe<GqlResolversTypes["Datetime"]>, ParentType, ContextType>;
  utilities?: Resolver<
    Maybe<GqlResolversTypes["UtilitiesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlCommunityUtilitiesArgs>
  >;
  wallets?: Resolver<
    Maybe<GqlResolversTypes["WalletsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlCommunityWalletsArgs>
  >;
  website?: Resolver<Maybe<GqlResolversTypes["String"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlCommunityCreatePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["CommunityCreatePayload"] = GqlResolversParentTypes["CommunityCreatePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"CommunityCreateSuccess", ParentType, ContextType>;
}>;

export type GqlCommunityCreateSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["CommunityCreateSuccess"] = GqlResolversParentTypes["CommunityCreateSuccess"],
> = ResolversObject<{
  community?: Resolver<GqlResolversTypes["Community"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlCommunityDeletePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["CommunityDeletePayload"] = GqlResolversParentTypes["CommunityDeletePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"CommunityDeleteSuccess", ParentType, ContextType>;
}>;

export type GqlCommunityDeleteSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["CommunityDeleteSuccess"] = GqlResolversParentTypes["CommunityDeleteSuccess"],
> = ResolversObject<{
  communityId?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlCommunityEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["CommunityEdge"] = GqlResolversParentTypes["CommunityEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlCommunityUpdateProfilePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["CommunityUpdateProfilePayload"] = GqlResolversParentTypes["CommunityUpdateProfilePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"CommunityUpdateProfileSuccess", ParentType, ContextType>;
}>;

export type GqlCommunityUpdateProfileSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["CommunityUpdateProfileSuccess"] = GqlResolversParentTypes["CommunityUpdateProfileSuccess"],
> = ResolversObject<{
  community?: Resolver<GqlResolversTypes["Community"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlCurrentPointViewResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["CurrentPointView"] = GqlResolversParentTypes["CurrentPointView"],
> = ResolversObject<{
...
export type GqlCurrentUserPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["CurrentUserPayload"] = GqlResolversParentTypes["CurrentUserPayload"],
> = ResolversObject<{
...
export interface GqlDecimalScalarConfig
  extends GraphQLScalarTypeConfig<GqlResolversTypes["Decimal"], any> {
  name: "Decimal";
}

export type GqlEarliestReservableSlotViewResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["EarliestReservableSlotView"] = GqlResolversParentTypes["EarliestReservableSlotView"],
> = ResolversObject<{
...
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    ...
    | "CommunityEdge"
    | "EvaluationEdge"
    | "EvaluationHistoryEdge"
    | "MembershipEdge"
    | "MembershipHistoryEdge"
    | "OpportunityEdge"
    | "OpportunitySlotEdge"
    | "ParticipationEdge"
    | "ParticipationStatusHistoryEdge"
    | "PlaceEdge"
    | "PortfolioEdge"
    | "ReservationEdge"
    | "ReservationHistoryEdge"
    | "TicketEdge"
    | "TicketStatusHistoryEdge"
    | "TransactionEdge"
    | "UserEdge"
    | "UtilityEdge"
    | "WalletEdge",
...
export type GqlEvaluationResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["Evaluation"] = GqlResolversParentTypes["Evaluation"],
> = ResolversObject<{
  ...
  evaluator?: Resolver<GqlResolversTypes["User"], ParentType, ContextType>;
  histories?: Resolver<
    Maybe<GqlResolversTypes["EvaluationHistoriesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlEvaluationHistoriesArgs>
  >;
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
...
export type GqlEvaluationCreatePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["EvaluationCreatePayload"] = GqlResolversParentTypes["EvaluationCreatePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"EvaluationCreateSuccess", ParentType, ContextType>;
}>;

export type GqlEvaluationCreateSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["EvaluationCreateSuccess"] = GqlResolversParentTypes["EvaluationCreateSuccess"],
> = ResolversObject<{
  evaluation?: Resolver<GqlResolversTypes["Evaluation"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlEvaluationEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["EvaluationEdge"] = GqlResolversParentTypes["EvaluationEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlEvaluationHistoriesConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["EvaluationHistoriesConnection"] = GqlResolversParentTypes["EvaluationHistoriesConnection"],
> = ResolversObject<{
...
export type GqlEvaluationHistoryResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["EvaluationHistory"] = GqlResolversParentTypes["EvaluationHistory"],
> = ResolversObject<{
  comment?: Resolver<Maybe<GqlResolversTypes["String"]>, ParentType, ContextType>;
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
...
export type GqlEvaluationHistoryEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["EvaluationHistoryEdge"] = GqlResolversParentTypes["EvaluationHistoryEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlEvaluationsConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["EvaluationsConnection"] = GqlResolversParentTypes["EvaluationsConnection"],
> = ResolversObject<{
...
export type GqlMembershipResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["Membership"] = GqlResolversParentTypes["Membership"],
> = ResolversObject<{
  bio?: Resolver<Maybe<GqlResolversTypes["String"]>, ParentType, ContextType>;
  community?: Resolver<GqlResolversTypes["Community"], ParentType, ContextType>;
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  headline?: Resolver<Maybe<GqlResolversTypes["String"]>, ParentType, ContextType>;
  membershipHistories?: Resolver<
    Maybe<GqlResolversTypes["MembershipHistoriesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlMembershipMembershipHistoriesArgs>
  >;
  participationView?: Resolver<
    Maybe<GqlResolversTypes["MembershipParticipationView"]>,
    ParentType,
    ContextType
  >;
...
export type GqlMembershipEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipEdge"] = GqlResolversParentTypes["MembershipEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlMembershipHistoriesConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipHistoriesConnection"] = GqlResolversParentTypes["MembershipHistoriesConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<Maybe<GqlResolversTypes["MembershipHistoryEdge"]>>>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<GqlResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type GqlMembershipHistoryResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipHistory"] = GqlResolversParentTypes["MembershipHistory"],
> = ResolversObject<{
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  createdByUser?: Resolver<Maybe<GqlResolversTypes["User"]>, ParentType, ContextType>;
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
...
export type GqlMembershipHistoryEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipHistoryEdge"] = GqlResolversParentTypes["MembershipHistoryEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
  node?: Resolver<Maybe<GqlResolversTypes["MembershipHistory"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlMembershipHostedMetricsResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipHostedMetrics"] = GqlResolversParentTypes["MembershipHostedMetrics"],
> = ResolversObject<{
  geo?: Resolver<
    Array<GqlResolversTypes["MembershipParticipationLocation"]>,
    ParentType,
    ContextType
  >;
...
export type GqlMembershipInvitePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipInvitePayload"] = GqlResolversParentTypes["MembershipInvitePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"MembershipInviteSuccess", ParentType, ContextType>;
}>;

export type GqlMembershipInviteSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipInviteSuccess"] = GqlResolversParentTypes["MembershipInviteSuccess"],
> = ResolversObject<{
  membership?: Resolver<GqlResolversTypes["Membership"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlMembershipParticipatedMetricsResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipParticipatedMetrics"] = GqlResolversParentTypes["MembershipParticipatedMetrics"],
> = ResolversObject<{
  geo?: Resolver<
    Array<GqlResolversTypes["MembershipParticipationLocation"]>,
    ParentType,
...
export type GqlMembershipParticipationLocationResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipParticipationLocation"] = GqlResolversParentTypes["MembershipParticipationLocation"],
> = ResolversObject<{
...
export type GqlMembershipParticipationViewResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipParticipationView"] = GqlResolversParentTypes["MembershipParticipationView"],
> = ResolversObject<{
  hosted?: Resolver<GqlResolversTypes["MembershipHostedMetrics"], ParentType, ContextType>;
  participated?: Resolver<
    GqlResolversTypes["MembershipParticipatedMetrics"],
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GqlMembershipRemovePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipRemovePayload"] = GqlResolversParentTypes["MembershipRemovePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"MembershipRemoveSuccess", ParentType, ContextType>;
}>;

export type GqlMembershipRemoveSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipRemoveSuccess"] = GqlResolversParentTypes["MembershipRemoveSuccess"],
> = ResolversObject<{
...
export type GqlMembershipSetInvitationStatusPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipSetInvitationStatusPayload"] = GqlResolversParentTypes["MembershipSetInvitationStatusPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"MembershipSetInvitationStatusSuccess", ParentType, ContextType>;
}>;

export type GqlMembershipSetInvitationStatusSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipSetInvitationStatusSuccess"] = GqlResolversParentTypes["MembershipSetInvitationStatusSuccess"],
> = ResolversObject<{
  membership?: Resolver<GqlResolversTypes["Membership"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlMembershipSetRolePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipSetRolePayload"] = GqlResolversParentTypes["MembershipSetRolePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"MembershipSetRoleSuccess", ParentType, ContextType>;
}>;

export type GqlMembershipSetRoleSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipSetRoleSuccess"] = GqlResolversParentTypes["MembershipSetRoleSuccess"],
> = ResolversObject<{
  membership?: Resolver<GqlResolversTypes["Membership"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlMembershipWithdrawPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipWithdrawPayload"] = GqlResolversParentTypes["MembershipWithdrawPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"MembershipWithdrawSuccess", ParentType, ContextType>;
}>;

export type GqlMembershipWithdrawSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipWithdrawSuccess"] = GqlResolversParentTypes["MembershipWithdrawSuccess"],
> = ResolversObject<{
  communityId?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
  userId?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GqlMembershipsConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["MembershipsConnection"] = GqlResolversParentTypes["MembershipsConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<Maybe<GqlResolversTypes["MembershipEdge"]>>>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<GqlResolversTypes["PageInfo"], ParentType, ContextType>;
...
> = ResolversObject<{
  communityCreate?: Resolver<
    Maybe<GqlResolversTypes["CommunityCreatePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationCommunityCreateArgs, "input">
  >;
  communityDelete?: Resolver<
    Maybe<GqlResolversTypes["CommunityDeletePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationCommunityDeleteArgs, "id" | "permission">
  >;
  communityUpdateProfile?: Resolver<
    Maybe<GqlResolversTypes["CommunityUpdateProfilePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationCommunityUpdateProfileArgs, "id" | "input" | "permission">
  >;
  evaluationFail?: Resolver<
    Maybe<GqlResolversTypes["EvaluationCreatePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationEvaluationFailArgs, "input" | "permission">
  >;
  evaluationPass?: Resolver<
    Maybe<GqlResolversTypes["EvaluationCreatePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationEvaluationPassArgs, "input" | "permission">
  >;
  membershipAcceptMyInvitation?: Resolver<
    Maybe<GqlResolversTypes["MembershipSetInvitationStatusPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationMembershipAcceptMyInvitationArgs, "input" | "permission">
  >;
  membershipAssignManager?: Resolver<
    Maybe<GqlResolversTypes["MembershipSetRolePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationMembershipAssignManagerArgs, "input" | "permission">
  >;
  membershipAssignMember?: Resolver<
    Maybe<GqlResolversTypes["MembershipSetRolePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationMembershipAssignMemberArgs, "input" | "permission">
  >;
  membershipAssignOwner?: Resolver<
    Maybe<GqlResolversTypes["MembershipSetRolePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationMembershipAssignOwnerArgs, "input" | "permission">
  >;
  membershipCancelInvitation?: Resolver<
    Maybe<GqlResolversTypes["MembershipSetInvitationStatusPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationMembershipCancelInvitationArgs, "input" | "permission">
  >;
  membershipDenyMyInvitation?: Resolver<
    Maybe<GqlResolversTypes["MembershipSetInvitationStatusPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationMembershipDenyMyInvitationArgs, "input" | "permission">
  >;
  membershipInvite?: Resolver<
    Maybe<GqlResolversTypes["MembershipInvitePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationMembershipInviteArgs, "input" | "permission">
  >;
  membershipRemove?: Resolver<
    Maybe<GqlResolversTypes["MembershipRemovePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationMembershipRemoveArgs, "input" | "permission">
  >;
  membershipWithdraw?: Resolver<
    Maybe<GqlResolversTypes["MembershipWithdrawPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationMembershipWithdrawArgs, "input" | "permission">
  >;
  mutationEcho?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
  opportunityCreate?: Resolver<
    Maybe<GqlResolversTypes["OpportunityCreatePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationOpportunityCreateArgs, "input" | "permission">
  >;
  opportunityDelete?: Resolver<
    Maybe<GqlResolversTypes["OpportunityDeletePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationOpportunityDeleteArgs, "id" | "permission">
  >;
  opportunitySetPublishStatus?: Resolver<
    Maybe<GqlResolversTypes["OpportunitySetPublishStatusPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationOpportunitySetPublishStatusArgs, "id" | "input" | "permission">
  >;
  opportunitySlotSetHostingStatus?: Resolver<
    Maybe<GqlResolversTypes["OpportunitySlotSetHostingStatusPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationOpportunitySlotSetHostingStatusArgs, "id" | "input" | "permission">
  >;
  opportunitySlotsBulkUpdate?: Resolver<
    Maybe<GqlResolversTypes["OpportunitySlotsBulkUpdatePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationOpportunitySlotsBulkUpdateArgs, "input" | "permission">
  >;
  opportunityUpdateContent?: Resolver<
    Maybe<GqlResolversTypes["OpportunityUpdateContentPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationOpportunityUpdateContentArgs, "id" | "input" | "permission">
  >;
  participationCreatePersonalRecord?: Resolver<
    Maybe<GqlResolversTypes["ParticipationCreatePersonalRecordPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationParticipationCreatePersonalRecordArgs, "input">
  >;
  participationDeletePersonalRecord?: Resolver<
    Maybe<GqlResolversTypes["ParticipationDeletePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationParticipationDeletePersonalRecordArgs, "id" | "permission">
  >;
  placeCreate?: Resolver<
    Maybe<GqlResolversTypes["PlaceCreatePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationPlaceCreateArgs, "input" | "permission">
  >;
  placeDelete?: Resolver<
    Maybe<GqlResolversTypes["PlaceDeletePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationPlaceDeleteArgs, "id" | "permission">
  >;
  placeUpdate?: Resolver<
    Maybe<GqlResolversTypes["PlaceUpdatePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationPlaceUpdateArgs, "id" | "input" | "permission">
  >;
  reservationAccept?: Resolver<
    Maybe<GqlResolversTypes["ReservationSetStatusPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationReservationAcceptArgs, "id" | "permission">
  >;
  reservationCancel?: Resolver<
    Maybe<GqlResolversTypes["ReservationSetStatusPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationReservationCancelArgs, "id" | "input" | "permission">
  >;
  reservationCreate?: Resolver<
    Maybe<GqlResolversTypes["ReservationCreatePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationReservationCreateArgs, "input">
  >;
  reservationJoin?: Resolver<
    Maybe<GqlResolversTypes["ReservationSetStatusPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationReservationJoinArgs, "id">
  >;
  reservationReject?: Resolver<
    Maybe<GqlResolversTypes["ReservationSetStatusPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationReservationRejectArgs, "id" | "permission">
  >;
  ticketClaim?: Resolver<
    Maybe<GqlResolversTypes["TicketClaimPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationTicketClaimArgs, "input">
  >;
  ticketIssue?: Resolver<
    Maybe<GqlResolversTypes["TicketIssuePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationTicketIssueArgs, "input" | "permission">
  >;
  ticketPurchase?: Resolver<
    Maybe<GqlResolversTypes["TicketPurchasePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationTicketPurchaseArgs, "input" | "permission">
  >;
  ticketRefund?: Resolver<
    Maybe<GqlResolversTypes["TicketRefundPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationTicketRefundArgs, "id" | "input" | "permission">
  >;
  ticketUse?: Resolver<
    Maybe<GqlResolversTypes["TicketUsePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationTicketUseArgs, "id" | "permission">
  >;
  transactionDonateSelfPoint?: Resolver<
    Maybe<GqlResolversTypes["TransactionDonateSelfPointPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationTransactionDonateSelfPointArgs, "input" | "permission">
  >;
  transactionGrantCommunityPoint?: Resolver<
    Maybe<GqlResolversTypes["TransactionGrantCommunityPointPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationTransactionGrantCommunityPointArgs, "input" | "permission">
  >;
  transactionIssueCommunityPoint?: Resolver<
    Maybe<GqlResolversTypes["TransactionIssueCommunityPointPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationTransactionIssueCommunityPointArgs, "input" | "permission">
  >;
  userDeleteMe?: Resolver<
    Maybe<GqlResolversTypes["UserDeletePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationUserDeleteMeArgs, "input" | "permission">
  >;
  userSignUp?: Resolver<
    Maybe<GqlResolversTypes["CurrentUserPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationUserSignUpArgs, "input">
  >;
  userUpdateMyProfile?: Resolver<
    Maybe<GqlResolversTypes["UserUpdateProfilePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationUserUpdateMyProfileArgs, "input" | "permission">
  >;
  utilityCreate?: Resolver<
    Maybe<GqlResolversTypes["UtilityCreatePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationUtilityCreateArgs, "input" | "permission">
  >;
  utilityDelete?: Resolver<
    Maybe<GqlResolversTypes["UtilityDeletePayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationUtilityDeleteArgs, "id" | "permission">
  >;
  utilitySetPublishStatus?: Resolver<
    Maybe<GqlResolversTypes["UtilitySetPublishStatusPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationUtilitySetPublishStatusArgs, "id" | "input" | "permission">
  >;
  utilityUpdateInfo?: Resolver<
    Maybe<GqlResolversTypes["UtilityUpdateInfoPayload"]>,
    ParentType,
    ContextType,
    RequireFields<GqlMutationUtilityUpdateInfoArgs, "id" | "input" | "permission">
  >;
}>;

export type GqlOpportunitiesConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunitiesConnection"] = GqlResolversParentTypes["OpportunitiesConnection"],
> = ResolversObject<{
...
export type GqlOpportunityResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["Opportunity"] = GqlResolversParentTypes["Opportunity"],
> = ResolversObject<{
  ...
  earliestReservableSlotView?: Resolver<
    Maybe<GqlResolversTypes["EarliestReservableSlotView"]>,
    ParentType,
    ContextType
  >;
  ...
  slots?: Resolver<
    Maybe<GqlResolversTypes["OpportunitySlotsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlOpportunitySlotsArgs>
  >;
  title?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
  updatedAt?: Resolver<Maybe<GqlResolversTypes["Datetime"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GqlOpportunityCreatePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunityCreatePayload"] = GqlResolversParentTypes["OpportunityCreatePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"OpportunityCreateSuccess", ParentType, ContextType>;
}>;

export type GqlOpportunityCreateSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunityCreateSuccess"] = GqlResolversParentTypes["OpportunityCreateSuccess"],
> = ResolversObject<{
  opportunity?: Resolver<GqlResolversTypes["Opportunity"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlOpportunityDeletePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunityDeletePayload"] = GqlResolversParentTypes["OpportunityDeletePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"OpportunityDeleteSuccess", ParentType, ContextType>;
}>;

export type GqlOpportunityDeleteSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunityDeleteSuccess"] = GqlResolversParentTypes["OpportunityDeleteSuccess"],
> = ResolversObject<{
  opportunityId?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlOpportunityEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunityEdge"] = GqlResolversParentTypes["OpportunityEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlOpportunitySetPublishStatusPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunitySetPublishStatusPayload"] = GqlResolversParentTypes["OpportunitySetPublishStatusPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"OpportunitySetPublishStatusSuccess", ParentType, ContextType>;
}>;

export type GqlOpportunitySetPublishStatusSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunitySetPublishStatusSuccess"] = GqlResolversParentTypes["OpportunitySetPublishStatusSuccess"],
> = ResolversObject<{
  opportunity?: Resolver<GqlResolversTypes["Opportunity"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlOpportunitySlotResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunitySlot"] = GqlResolversParentTypes["OpportunitySlot"],
> = ResolversObject<{
  capacity?: Resolver<Maybe<GqlResolversTypes["Int"]>, ParentType, ContextType>;
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  endsAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  hostingStatus?: Resolver<
    GqlResolversTypes["OpportunitySlotHostingStatus"],
    ParentType,
    ContextType
  >;
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
  ...
  participations?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<GqlOpportunitySlotParticipationsArgs>
  >;
  remainingCapacityView?: Resolver<
    Maybe<GqlResolversTypes["RemainingCapacityView"]>,
    ParentType,
    ContextType
  >;
  reservations?: Resolver<
    Maybe<GqlResolversTypes["ReservationsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlOpportunitySlotReservationsArgs>
  >;
...
export type GqlOpportunitySlotEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunitySlotEdge"] = GqlResolversParentTypes["OpportunitySlotEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlOpportunitySlotSetHostingStatusPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunitySlotSetHostingStatusPayload"] = GqlResolversParentTypes["OpportunitySlotSetHostingStatusPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"OpportunitySlotSetHostingStatusSuccess", ParentType, ContextType>;
}>;

export type GqlOpportunitySlotSetHostingStatusSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunitySlotSetHostingStatusSuccess"] = GqlResolversParentTypes["OpportunitySlotSetHostingStatusSuccess"],
> = ResolversObject<{
  slot?: Resolver<GqlResolversTypes["OpportunitySlot"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlOpportunitySlotsBulkUpdatePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunitySlotsBulkUpdatePayload"] = GqlResolversParentTypes["OpportunitySlotsBulkUpdatePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"OpportunitySlotsBulkUpdateSuccess", ParentType, ContextType>;
}>;

export type GqlOpportunitySlotsBulkUpdateSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunitySlotsBulkUpdateSuccess"] = GqlResolversParentTypes["OpportunitySlotsBulkUpdateSuccess"],
> = ResolversObject<{
  slots?: Resolver<Array<GqlResolversTypes["OpportunitySlot"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlOpportunitySlotsConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunitySlotsConnection"] = GqlResolversParentTypes["OpportunitySlotsConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<Maybe<GqlResolversTypes["OpportunitySlotEdge"]>>>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<GqlResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type GqlOpportunityUpdateContentPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunityUpdateContentPayload"] = GqlResolversParentTypes["OpportunityUpdateContentPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"OpportunityUpdateContentSuccess", ParentType, ContextType>;
}>;

export type GqlOpportunityUpdateContentSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["OpportunityUpdateContentSuccess"] = GqlResolversParentTypes["OpportunityUpdateContentSuccess"],
> = ResolversObject<{
  opportunity?: Resolver<GqlResolversTypes["Opportunity"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type GqlParticipationResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["Participation"] = GqlResolversParentTypes["Participation"],
> = ResolversObject<{
  community?: Resolver<Maybe<GqlResolversTypes["Community"]>, ParentType, ContextType>;
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  ...
  statusHistories?: Resolver<
    Maybe<GqlResolversTypes["ParticipationStatusHistoriesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlParticipationStatusHistoriesArgs>
  >;
  ticketStatusHistories?: Resolver<
    Maybe<Array<GqlResolversTypes["TicketStatusHistory"]>>,
    ParentType,
    ContextType
  >;
  transactions?: Resolver<
    Maybe<GqlResolversTypes["TransactionsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlParticipationTransactionsArgs>
  >;
  updatedAt?: Resolver<Maybe<GqlResolversTypes["Datetime"]>, ParentType, ContextType>;
  user?: Resolver<Maybe<GqlResolversTypes["User"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GqlParticipationCreatePersonalRecordPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ParticipationCreatePersonalRecordPayload"] = GqlResolversParentTypes["ParticipationCreatePersonalRecordPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"ParticipationCreatePersonalRecordSuccess", ParentType, ContextType>;
}>;

export type GqlParticipationCreatePersonalRecordSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ParticipationCreatePersonalRecordSuccess"] = GqlResolversParentTypes["ParticipationCreatePersonalRecordSuccess"],
> = ResolversObject<{
  participation?: Resolver<GqlResolversTypes["Participation"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlParticipationDeletePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ParticipationDeletePayload"] = GqlResolversParentTypes["ParticipationDeletePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"ParticipationDeleteSuccess", ParentType, ContextType>;
}>;

export type GqlParticipationDeleteSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ParticipationDeleteSuccess"] = GqlResolversParentTypes["ParticipationDeleteSuccess"],
> = ResolversObject<{
  participationId?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlParticipationEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ParticipationEdge"] = GqlResolversParentTypes["ParticipationEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlParticipationStatusHistoriesConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ParticipationStatusHistoriesConnection"] = GqlResolversParentTypes["ParticipationStatusHistoriesConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Array<GqlResolversTypes["ParticipationStatusHistoryEdge"]>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<GqlResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type GqlParticipationStatusHistoryResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ParticipationStatusHistory"] = GqlResolversParentTypes["ParticipationStatusHistory"],
> = ResolversObject<{
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  createdByUser?: Resolver<Maybe<GqlResolversTypes["User"]>, ParentType, ContextType>;
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
...
export type GqlParticipationStatusHistoryEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ParticipationStatusHistoryEdge"] = GqlResolversParentTypes["ParticipationStatusHistoryEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlParticipationsConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ParticipationsConnection"] = GqlResolversParentTypes["ParticipationsConnection"],
> = ResolversObject<{
...
export type GqlPlaceResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["Place"] = GqlResolversParentTypes["Place"],
> = ResolversObject<{
  address?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
  ...
  opportunities?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<GqlPlaceOpportunitiesArgs>
  >;
  updatedAt?: Resolver<Maybe<GqlResolversTypes["Datetime"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlPlaceCreatePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["PlaceCreatePayload"] = GqlResolversParentTypes["PlaceCreatePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"PlaceCreateSuccess", ParentType, ContextType>;
}>;

export type GqlPlaceCreateSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["PlaceCreateSuccess"] = GqlResolversParentTypes["PlaceCreateSuccess"],
> = ResolversObject<{
  place?: Resolver<GqlResolversTypes["Place"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlPlaceDeletePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["PlaceDeletePayload"] = GqlResolversParentTypes["PlaceDeletePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"PlaceDeleteSuccess", ParentType, ContextType>;
}>;

export type GqlPlaceDeleteSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["PlaceDeleteSuccess"] = GqlResolversParentTypes["PlaceDeleteSuccess"],
> = ResolversObject<{
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlPlaceEdgeResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["PlaceEdge"] = GqlResolversParentTypes["PlaceEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlPlaceUpdatePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["PlaceUpdatePayload"] = GqlResolversParentTypes["PlaceUpdatePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"PlaceUpdateSuccess", ParentType, ContextType>;
}>;

export type GqlPlaceUpdateSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["PlaceUpdateSuccess"] = GqlResolversParentTypes["PlaceUpdateSuccess"],
> = ResolversObject<{
  place?: Resolver<GqlResolversTypes["Place"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlPlacesConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["PlacesConnection"] = GqlResolversParentTypes["PlacesConnection"],
> = ResolversObject<{
...
export type GqlPortfolioResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["Portfolio"] = GqlResolversParentTypes["Portfolio"],
> = ResolversObject<{
  ...
  reservationStatus?: Resolver<
    Maybe<GqlResolversTypes["ReservationStatus"]>,
    ParentType,
    ContextType
  >;
...
export type GqlPortfolioEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["PortfolioEdge"] = GqlResolversParentTypes["PortfolioEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlPortfoliosConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["PortfoliosConnection"] = GqlResolversParentTypes["PortfoliosConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<Maybe<GqlResolversTypes["PortfolioEdge"]>>>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<GqlResolversTypes["PageInfo"], ParentType, ContextType>;
...
> = ResolversObject<{
  article?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<GqlQueryArticleArgs, "id" | "permission">
  >;
  articles?: Resolver<
    GqlResolversTypes["ArticlesConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryArticlesArgs>
  >;
  cities?: Resolver<
  ...
  communities?: Resolver<
    GqlResolversTypes["CommunitiesConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryCommunitiesArgs>
  >;
  community?: Resolver<
    Maybe<GqlResolversTypes["Community"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryCommunityArgs, "id">
  >;
  ...
  evaluation?: Resolver<
    Maybe<GqlResolversTypes["Evaluation"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryEvaluationArgs, "id">
  >;
  evaluationHistories?: Resolver<
    GqlResolversTypes["EvaluationHistoriesConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryEvaluationHistoriesArgs>
  >;
  evaluationHistory?: Resolver<
    Maybe<GqlResolversTypes["EvaluationHistory"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryEvaluationHistoryArgs, "id">
  >;
  evaluations?: Resolver<
    GqlResolversTypes["EvaluationsConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryEvaluationsArgs>
  >;
  membership?: Resolver<
    Maybe<GqlResolversTypes["Membership"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryMembershipArgs, "communityId" | "userId">
  >;
  membershipHistories?: Resolver<
    GqlResolversTypes["MembershipHistoriesConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryMembershipHistoriesArgs>
  >;
  membershipHistory?: Resolver<
    Maybe<GqlResolversTypes["MembershipHistory"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryMembershipHistoryArgs, "id">
  >;
  memberships?: Resolver<
    GqlResolversTypes["MembershipsConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryMembershipsArgs>
  >;
  opportunities?: Resolver<
    GqlResolversTypes["OpportunitiesConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryOpportunitiesArgs>
  >;
  opportunity?: Resolver<
    Maybe<GqlResolversTypes["Opportunity"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryOpportunityArgs, "id" | "permission">
  >;
  opportunitySlot?: Resolver<
    Maybe<GqlResolversTypes["OpportunitySlot"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryOpportunitySlotArgs, "id">
  >;
  opportunitySlots?: Resolver<
    GqlResolversTypes["OpportunitySlotsConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryOpportunitySlotsArgs>
  >;
  participation?: Resolver<
    Maybe<GqlResolversTypes["Participation"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryParticipationArgs, "id">
  >;
  participationStatusHistories?: Resolver<
    GqlResolversTypes["ParticipationStatusHistoriesConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryParticipationStatusHistoriesArgs>
  >;
  participationStatusHistory?: Resolver<
    Maybe<GqlResolversTypes["ParticipationStatusHistory"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryParticipationStatusHistoryArgs, "id">
  >;
  participations?: Resolver<
    GqlResolversTypes["ParticipationsConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryParticipationsArgs>
  >;
  place?: Resolver<
    Maybe<GqlResolversTypes["Place"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryPlaceArgs, "id">
  >;
  places?: Resolver<
    GqlResolversTypes["PlacesConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryPlacesArgs>
  >;
  portfolios?: Resolver<
    GqlResolversTypes["PortfoliosConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryPortfoliosArgs>
  >;
  reservation?: Resolver<
    Maybe<GqlResolversTypes["Reservation"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryReservationArgs, "id">
  >;
  reservationHistories?: Resolver<
    GqlResolversTypes["ReservationHistoriesConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryReservationHistoriesArgs>
  >;
  reservationHistory?: Resolver<
    Maybe<GqlResolversTypes["ReservationHistory"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryReservationHistoryArgs, "id">
  >;
  reservations?: Resolver<
    GqlResolversTypes["ReservationsConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryReservationsArgs>
  >;
  states?: Resolver<
  ...
  >;
  ticket?: Resolver<
    Maybe<GqlResolversTypes["Ticket"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryTicketArgs, "id">
  >;
  ticketStatusHistories?: Resolver<
    GqlResolversTypes["TicketStatusHistoriesConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryTicketStatusHistoriesArgs>
  >;
  ticketStatusHistory?: Resolver<
    Maybe<GqlResolversTypes["TicketStatusHistory"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryTicketStatusHistoryArgs, "id">
  >;
  tickets?: Resolver<
    GqlResolversTypes["TicketsConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryTicketsArgs>
  >;
  transaction?: Resolver<
    Maybe<GqlResolversTypes["Transaction"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryTransactionArgs, "id">
  >;
  transactions?: Resolver<
    GqlResolversTypes["TransactionsConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryTransactionsArgs>
  >;
  user?: Resolver<
  ...
  >;
  utilities?: Resolver<
    GqlResolversTypes["UtilitiesConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryUtilitiesArgs>
  >;
  utility?: Resolver<
    Maybe<GqlResolversTypes["Utility"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryUtilityArgs, "id" | "permission">
  >;
  wallet?: Resolver<
    Maybe<GqlResolversTypes["Wallet"]>,
    ParentType,
    ContextType,
    RequireFields<GqlQueryWalletArgs, "id">
  >;
  wallets?: Resolver<
    GqlResolversTypes["WalletsConnection"],
    ParentType,
    ContextType,
    Partial<GqlQueryWalletsArgs>
  >;
}>;

export type GqlRemainingCapacityViewResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["RemainingCapacityView"] = GqlResolversParentTypes["RemainingCapacityView"],
> = ResolversObject<{
...
export type GqlReservationResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["Reservation"] = GqlResolversParentTypes["Reservation"],
> = ResolversObject<{
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  createdByUser?: Resolver<Maybe<GqlResolversTypes["User"]>, ParentType, ContextType>;
  histories?: Resolver<
    Maybe<Array<GqlResolversTypes["ReservationHistory"]>>,
    ParentType,
    ContextType
  >;
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
  ...
  participations?: Resolver<
    Maybe<Array<GqlResolversTypes["Participation"]>>,
    ParentType,
    ContextType
  >;
...
export type GqlReservationCreatePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ReservationCreatePayload"] = GqlResolversParentTypes["ReservationCreatePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"ReservationCreateSuccess", ParentType, ContextType>;
}>;

export type GqlReservationCreateSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ReservationCreateSuccess"] = GqlResolversParentTypes["ReservationCreateSuccess"],
> = ResolversObject<{
  reservation?: Resolver<GqlResolversTypes["Reservation"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlReservationEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ReservationEdge"] = GqlResolversParentTypes["ReservationEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlReservationHistoriesConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ReservationHistoriesConnection"] = GqlResolversParentTypes["ReservationHistoriesConnection"],
> = ResolversObject<{
...
export type GqlReservationHistoryResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ReservationHistory"] = GqlResolversParentTypes["ReservationHistory"],
> = ResolversObject<{
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  createdByUser?: Resolver<Maybe<GqlResolversTypes["User"]>, ParentType, ContextType>;
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
...
export type GqlReservationHistoryEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ReservationHistoryEdge"] = GqlResolversParentTypes["ReservationHistoryEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlReservationSetStatusPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ReservationSetStatusPayload"] = GqlResolversParentTypes["ReservationSetStatusPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"ReservationSetStatusSuccess", ParentType, ContextType>;
}>;

export type GqlReservationSetStatusSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ReservationSetStatusSuccess"] = GqlResolversParentTypes["ReservationSetStatusSuccess"],
> = ResolversObject<{
  reservation?: Resolver<GqlResolversTypes["Reservation"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlReservationsConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["ReservationsConnection"] = GqlResolversParentTypes["ReservationsConnection"],
> = ResolversObject<{
...
export type GqlTicketResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["Ticket"] = GqlResolversParentTypes["Ticket"],
> = ResolversObject<{
  ...
  ticketStatusHistories?: Resolver<
    Maybe<GqlResolversTypes["TicketStatusHistoriesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlTicketTicketStatusHistoriesArgs>
  >;
  updatedAt?: Resolver<Maybe<GqlResolversTypes["Datetime"]>, ParentType, ContextType>;
...
export type GqlTicketClaimLinkResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["TicketClaimLink"] = GqlResolversParentTypes["TicketClaimLink"],
> = ResolversObject<{
...
export type GqlTicketClaimPayloadResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["TicketClaimPayload"] = GqlResolversParentTypes["TicketClaimPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"TicketClaimSuccess", ParentType, ContextType>;
}>;

export type GqlTicketClaimSuccessResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["TicketClaimSuccess"] = GqlResolversParentTypes["TicketClaimSuccess"],
> = ResolversObject<{
  tickets?: Resolver<Array<GqlResolversTypes["Ticket"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlTicketEdgeResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["TicketEdge"] = GqlResolversParentTypes["TicketEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlTicketIssuePayloadResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["TicketIssuePayload"] = GqlResolversParentTypes["TicketIssuePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"TicketIssueSuccess", ParentType, ContextType>;
}>;

export type GqlTicketIssueSuccessResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["TicketIssueSuccess"] = GqlResolversParentTypes["TicketIssueSuccess"],
> = ResolversObject<{
  issue?: Resolver<GqlResolversTypes["TicketIssuer"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlTicketIssuerResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["TicketIssuer"] = GqlResolversParentTypes["TicketIssuer"],
> = ResolversObject<{
  claimLink?: Resolver<Maybe<GqlResolversTypes["TicketClaimLink"]>, ParentType, ContextType>;
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
...
export type GqlTicketPurchasePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TicketPurchasePayload"] = GqlResolversParentTypes["TicketPurchasePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"TicketPurchaseSuccess", ParentType, ContextType>;
}>;

export type GqlTicketPurchaseSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TicketPurchaseSuccess"] = GqlResolversParentTypes["TicketPurchaseSuccess"],
> = ResolversObject<{
  ticket?: Resolver<GqlResolversTypes["Ticket"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlTicketRefundPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TicketRefundPayload"] = GqlResolversParentTypes["TicketRefundPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"TicketRefundSuccess", ParentType, ContextType>;
}>;

export type GqlTicketRefundSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TicketRefundSuccess"] = GqlResolversParentTypes["TicketRefundSuccess"],
> = ResolversObject<{
  ticket?: Resolver<GqlResolversTypes["Ticket"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlTicketStatusHistoriesConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TicketStatusHistoriesConnection"] = GqlResolversParentTypes["TicketStatusHistoriesConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<Maybe<GqlResolversTypes["TicketStatusHistoryEdge"]>>>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<GqlResolversTypes["PageInfo"], ParentType, ContextType>;
...
export type GqlTicketStatusHistoryResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TicketStatusHistory"] = GqlResolversParentTypes["TicketStatusHistory"],
> = ResolversObject<{
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  createdByUser?: Resolver<Maybe<GqlResolversTypes["User"]>, ParentType, ContextType>;
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
...
export type GqlTicketStatusHistoryEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TicketStatusHistoryEdge"] = GqlResolversParentTypes["TicketStatusHistoryEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlTicketUsePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TicketUsePayload"] = GqlResolversParentTypes["TicketUsePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"TicketUseSuccess", ParentType, ContextType>;
}>;

export type GqlTicketUseSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TicketUseSuccess"] = GqlResolversParentTypes["TicketUseSuccess"],
> = ResolversObject<{
  ticket?: Resolver<GqlResolversTypes["Ticket"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlTicketsConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TicketsConnection"] = GqlResolversParentTypes["TicketsConnection"],
> = ResolversObject<{
...
export type GqlTransactionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["Transaction"] = GqlResolversParentTypes["Transaction"],
> = ResolversObject<{
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  ...
  ticketStatusHistories?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<GqlTransactionTicketStatusHistoriesArgs>
  >;
...
export type GqlTransactionDonateSelfPointPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TransactionDonateSelfPointPayload"] = GqlResolversParentTypes["TransactionDonateSelfPointPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"TransactionDonateSelfPointSuccess", ParentType, ContextType>;
}>;

export type GqlTransactionDonateSelfPointSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TransactionDonateSelfPointSuccess"] = GqlResolversParentTypes["TransactionDonateSelfPointSuccess"],
> = ResolversObject<{
...
export type GqlTransactionEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TransactionEdge"] = GqlResolversParentTypes["TransactionEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlTransactionGrantCommunityPointPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TransactionGrantCommunityPointPayload"] = GqlResolversParentTypes["TransactionGrantCommunityPointPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"TransactionGrantCommunityPointSuccess", ParentType, ContextType>;
}>;

export type GqlTransactionGrantCommunityPointSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TransactionGrantCommunityPointSuccess"] = GqlResolversParentTypes["TransactionGrantCommunityPointSuccess"],
> = ResolversObject<{
  transaction?: Resolver<GqlResolversTypes["Transaction"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlTransactionIssueCommunityPointPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TransactionIssueCommunityPointPayload"] = GqlResolversParentTypes["TransactionIssueCommunityPointPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"TransactionIssueCommunityPointSuccess", ParentType, ContextType>;
}>;

export type GqlTransactionIssueCommunityPointSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TransactionIssueCommunityPointSuccess"] = GqlResolversParentTypes["TransactionIssueCommunityPointSuccess"],
> = ResolversObject<{
  transaction?: Resolver<GqlResolversTypes["Transaction"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlTransactionsConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["TransactionsConnection"] = GqlResolversParentTypes["TransactionsConnection"],
> = ResolversObject<{
  edges?: Resolver<
    Maybe<Array<Maybe<GqlResolversTypes["TransactionEdge"]>>>,
    ParentType,
    ContextType
  >;
  pageInfo?: Resolver<GqlResolversTypes["PageInfo"], ParentType, ContextType>;
...
> = ResolversObject<{
  articlesAboutMe?: Resolver<
    Maybe<GqlResolversTypes["ArticlesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserArticlesAboutMeArgs>
  >;
  articlesWrittenByMe?: Resolver<
    Maybe<GqlResolversTypes["ArticlesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserArticlesWrittenByMeArgs>
  >;
  bio?: Resolver<Maybe<GqlResolversTypes["String"]>, ParentType, ContextType>;
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  currentPrefecture?: Resolver<
    Maybe<GqlResolversTypes["CurrentPrefecture"]>,
    ParentType,
    ContextType
  >;
  evaluationCreatedByMe?: Resolver<
    Maybe<GqlResolversTypes["EvaluationHistoriesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserEvaluationCreatedByMeArgs>
  >;
  evaluations?: Resolver<
    Maybe<GqlResolversTypes["EvaluationsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserEvaluationsArgs>
  >;
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
  image?: Resolver<Maybe<GqlResolversTypes["String"]>, ParentType, ContextType>;
  membershipChangedByMe?: Resolver<
    Maybe<GqlResolversTypes["MembershipHistoriesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserMembershipChangedByMeArgs>
  >;
  memberships?: Resolver<
    Maybe<GqlResolversTypes["MembershipsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserMembershipsArgs>
  >;
  name?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
  opportunitiesCreatedByMe?: Resolver<
    Maybe<GqlResolversTypes["OpportunitiesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserOpportunitiesCreatedByMeArgs>
  >;
  participationStatusChangedByMe?: Resolver<
    Maybe<GqlResolversTypes["ParticipationStatusHistoriesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserParticipationStatusChangedByMeArgs>
  >;
  participations?: Resolver<
    Maybe<GqlResolversTypes["ParticipationsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserParticipationsArgs>
  >;
  phoneNumber?: Resolver<Maybe<GqlResolversTypes["String"]>, ParentType, ContextType>;
  portfolios?: Resolver<
    Maybe<GqlResolversTypes["PortfoliosConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserPortfoliosArgs>
  >;
  reservationStatusChangedByMe?: Resolver<
    Maybe<GqlResolversTypes["ReservationHistoriesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserReservationStatusChangedByMeArgs>
  >;
  reservations?: Resolver<
    Maybe<GqlResolversTypes["ReservationsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserReservationsArgs>
  >;
  ...
  ticketStatusChangedByMe?: Resolver<
    Maybe<GqlResolversTypes["TicketStatusHistoriesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUserTicketStatusChangedByMeArgs>
  >;
  updatedAt?: Resolver<Maybe<GqlResolversTypes["Datetime"]>, ParentType, ContextType>;
...
export type GqlUserUpdateProfilePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UserUpdateProfilePayload"] = GqlResolversParentTypes["UserUpdateProfilePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"UserUpdateProfileSuccess", ParentType, ContextType>;
}>;

export type GqlUserUpdateProfileSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UserUpdateProfileSuccess"] = GqlResolversParentTypes["UserUpdateProfileSuccess"],
> = ResolversObject<{
  user?: Resolver<Maybe<GqlResolversTypes["User"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type GqlUtilitiesConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UtilitiesConnection"] = GqlResolversParentTypes["UtilitiesConnection"],
> = ResolversObject<{
...
export type GqlUtilityResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["Utility"] = GqlResolversParentTypes["Utility"],
> = ResolversObject<{
  community?: Resolver<GqlResolversTypes["Community"], ParentType, ContextType>;
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  description?: Resolver<Maybe<GqlResolversTypes["String"]>, ParentType, ContextType>;
  ...
  publishStatus?: Resolver<GqlResolversTypes["PublishStatus"], ParentType, ContextType>;
  requiredForOpportunities?: Resolver<
    Maybe<GqlResolversTypes["OpportunitiesConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUtilityRequiredForOpportunitiesArgs>
  >;
  ticketIssuers?: Resolver<
    Maybe<Array<GqlResolversTypes["TicketIssuer"]>>,
    ParentType,
    ContextType
  >;
  tickets?: Resolver<
    Maybe<GqlResolversTypes["TicketsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlUtilityTicketsArgs>
  >;
  updatedAt?: Resolver<Maybe<GqlResolversTypes["Datetime"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlUtilityCreatePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UtilityCreatePayload"] = GqlResolversParentTypes["UtilityCreatePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"UtilityCreateSuccess", ParentType, ContextType>;
}>;

export type GqlUtilityCreateSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UtilityCreateSuccess"] = GqlResolversParentTypes["UtilityCreateSuccess"],
> = ResolversObject<{
  utility?: Resolver<GqlResolversTypes["Utility"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlUtilityDeletePayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UtilityDeletePayload"] = GqlResolversParentTypes["UtilityDeletePayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"UtilityDeleteSuccess", ParentType, ContextType>;
}>;

export type GqlUtilityDeleteSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UtilityDeleteSuccess"] = GqlResolversParentTypes["UtilityDeleteSuccess"],
> = ResolversObject<{
  utilityId?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlUtilityEdgeResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UtilityEdge"] = GqlResolversParentTypes["UtilityEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlUtilitySetPublishStatusPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UtilitySetPublishStatusPayload"] = GqlResolversParentTypes["UtilitySetPublishStatusPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"UtilitySetPublishStatusSuccess", ParentType, ContextType>;
}>;

export type GqlUtilitySetPublishStatusSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UtilitySetPublishStatusSuccess"] = GqlResolversParentTypes["UtilitySetPublishStatusSuccess"],
> = ResolversObject<{
  utility?: Resolver<GqlResolversTypes["Utility"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type GqlUtilityUpdateInfoPayloadResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UtilityUpdateInfoPayload"] = GqlResolversParentTypes["UtilityUpdateInfoPayload"],
> = ResolversObject<{
  __resolveType: TypeResolveFn<"UtilityUpdateInfoSuccess", ParentType, ContextType>;
}>;

export type GqlUtilityUpdateInfoSuccessResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["UtilityUpdateInfoSuccess"] = GqlResolversParentTypes["UtilityUpdateInfoSuccess"],
> = ResolversObject<{
  utility?: Resolver<GqlResolversTypes["Utility"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
> = ResolversObject<{
  accumulatedPointView?: Resolver<
    Maybe<GqlResolversTypes["AccumulatedPointView"]>,
    ParentType,
    ContextType
  >;
  community?: Resolver<GqlResolversTypes["Community"], ParentType, ContextType>;
  createdAt?: Resolver<GqlResolversTypes["Datetime"], ParentType, ContextType>;
  currentPointView?: Resolver<
    Maybe<GqlResolversTypes["CurrentPointView"]>,
    ParentType,
    ContextType
  >;
  id?: Resolver<GqlResolversTypes["ID"], ParentType, ContextType>;
  tickets?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<GqlWalletTicketsArgs>
  >;
  transactions?: Resolver<
    Maybe<GqlResolversTypes["TransactionsConnection"]>,
    ParentType,
    ContextType,
    Partial<GqlWalletTransactionsArgs>
  >;
...
export type GqlWalletEdgeResolvers<
  ContextType = any,
  ParentType extends GqlResolversParentTypes["WalletEdge"] = GqlResolversParentTypes["WalletEdge"],
> = ResolversObject<{
  cursor?: Resolver<GqlResolversTypes["String"], ParentType, ContextType>;
...
export type GqlWalletsConnectionResolvers<
  ContextType = any,
  ParentType extends
    GqlResolversParentTypes["WalletsConnection"] = GqlResolversParentTypes["WalletsConnection"],
> = ResolversObject<{
...
export type GqlResolvers<ContextType = any> = ResolversObject<{
  ...
  EarliestReservableSlotView?: GqlEarliestReservableSlotViewResolvers<ContextType>;
