...
@injectable()
export default class CustomPropertiesService {
  buildCustomProps(input: Partial<CustomPropsV1>): string {
  ...
  parseCustomProps(raw: string): { success: true; data: CustomPropsV1 } | { success: false; error: string } {
    try {
