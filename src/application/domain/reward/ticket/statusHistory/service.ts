...
import TicketStatusHistoryConverter from "@/application/domain/reward/ticket/statusHistory/data/converter";
import TicketStatusHistoryRepository from "@/application/domain/reward/ticket/statusHistory/data/repository";
