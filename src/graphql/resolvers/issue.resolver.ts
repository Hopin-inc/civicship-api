...
const issueResolver = {
  Query: {
    issues: async (_: unknown, args: GqlQueryIssuesArgs) =>
      IssueService.queryIssues(args),
    issue: async (_: unknown, args: GqlQueryIssueArgs) =>
      IssueService.getIssue(args),
  },
  Mutation: {
    ...
    issueUpdate: async (_: unknown, args: GqlMutationIssueUpdateArgs) =>
      IssueService.issueUpdate(args),
    ...
    issueRemoveGroup: async (
      _: unknown,
      args: GqlMutationIssueRemoveGroupArgs,
    ) => IssueService.issueRemoveGroup(args),
    issueAddOrganization: async (
      _: unknown,
      args: GqlMutationIssueAddOrganizationArgs,
    ) => IssueService.issueAddOrganization(args),
    issueRemoveOrganization: async (
      _: unknown,
      args: GqlMutationIssueRemoveOrganizationArgs,
    ) => IssueService.issueRemoveOrganization(args),
    issueAddSkillset: async (
      _: unknown,
      args: GqlMutationIssueAddSkillsetArgs,
    ) => IssueService.issueAddSkillset(args),
    issueRemoveSkillset: async (
      _: unknown,
      args: GqlMutationIssueRemoveSkillsetArgs,
    ...
    issueAddCategory: async (
      _: unknown,
      args: GqlMutationIssueAddCategoryArgs,
    ) => IssueService.issueAddCategory(args),
    issueRemoveCategory: async (
      _: unknown,
      args: GqlMutationIssueRemoveCategoryArgs,
