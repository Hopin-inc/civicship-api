...
const activityResolver = {
  Query: {
    ...
    activity: async (_: unknown, args: GqlQueryActivityArgs) => ActivityService.getActivity(args),
  },
  Mutation: {
    ...
    activityUpdateUser: async (_: unknown, args: GqlMutationActivityUpdateUserArgs) =>
