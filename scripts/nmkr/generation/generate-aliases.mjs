...
const tryOps = {
  ...
  CheckUtxoResponse: pickOp({
    includes: ["checkaddress", "apikey", "address"],
    suffix: "Response",
  }),
  CheckAddressResponse: pickOp({
    includes: ["checkaddress", "apikey", "projectuid", "address"],
    suffix: "Response",
  }),
  CancelAddressReservationResponse: pickOp({
    includes: ["canceladdressreservation", "apikey", "projectuid", "paymentaddress"],
    suffix: "Response",
  }),

  // Project/NFT operations that exist
  GetCountsResponse: pickOp({
    includes: ["getcounts", "apikey", "projectuid"],
    suffix: "Response",
  }),
  GetNftDetailsByIdResponse: pickOp({
    includes: ["getnftdetailsbyid", "apikey", "nftuid"],
    suffix: "Response",
  }),
  GetNftsResponse: pickOp({
    includes: ["getnfts", "apikey", "projectuid", "state", "count", "page"],
    suffix: "Response",
  }),

  // Payment address operations that exist
  GetPaymentAddressForRandomNftSaleResponse: pickOp({
    includes: ["getaddressforrandomnftsale", "apikey", "projectuid", "countnft"],
    suffix: "Response",
  }),
  GetPaymentAddressForSpecificNftSaleResponse: pickOp({
    includes: ["getaddressforspecificnftsale", "apikey", "nftuid", "tokencount"],
    suffix: "Response",
  }),

  // Upload/Metadata operations that exist
  UploadNftRequest: pickOp({
    includes: ["uploadnft", "apikey", "nftprojectid"],
    suffix: "RequestBody",
  }),
  UploadNftResponse: pickOp({
    includes: ["uploadnft", "apikey", "nftprojectid"],
    suffix: "Response",
  }),
  UpdateMetadataRequest: pickOp({
    includes: ["updatemetadata", "apikey", "nftprojectid", "nftid"],
    suffix: "RequestBody",
  }),
  UpdateMetadataResponse: pickOp({
    includes: ["updatemetadata", "apikey", "nftprojectid", "nftid"],
    suffix: "Response",
  }),

  // Mint operations that exist
  MintAndSendRandomResponse: pickOp({
    includes: ["mintandsendrandom", "apikey", "nftprojectid", "countnft", "receiveraddress"],
    suffix: "Response",
  }),
  MintAndSendSpecificResponse: pickOp({
    includes: [
      "mintandsendspecific",
      "apikey",
      "nftprojectid",
  ...
  ProjectDetailsResponse: pickOp({
    includes: ["getprojectdetails", "apikey", "projectuid"],
    suffix: "Response",
  }),

  // Listing operations that exist
  ListProjectsResponse: pickOp({ includes: ["listprojects", "apikey"], suffix: "Response" }),
  ListProjectsPaginatedResponse: pickOp({
    includes: ["listprojects", "apikey", "count", "page"],
    suffix: "Response",
  }),
  ListProjectsCustomerResponse: pickOp({
    includes: ["listprojects", "apikey", "customerid", "count", "page"],
    suffix: "Response",
  }),

  // Delete operations that exist
  DeleteNftResponse: pickOp({
    includes: ["deletenft", "apikey", "nftprojectid", "nftid"],
    suffix: "Response",
  }),
  DeleteNftByUidResponse: pickOp({
    includes: ["deletenft", "apikey", "nftuid"],
    suffix: "Response",
  }),

  // Wallet validation that exists
  CheckWalletValidationResponse: pickOp({
    includes: ["checkwalletvalidation", "apikey", "validationuid", "lovelace"],
    suffix: "Response",
  }),
  GetWalletValidationAddressResponse: pickOp({
    includes: ["getwalletvalidationaddress", "apikey", "validationname"],
    suffix: "Response",
  }),

  // POST operations for GetAddressForSpecificNftSale that exist
  GetAddressForSpecificNftSaleRequestBody: pickOp({
    includes: ["getaddressforspecificnftsale", "apikey", "nftprojectid"],
    suffix: "RequestBody",
  }),
  GetAddressForSpecificNftSalePostResponse: pickOp({
    includes: ["getaddressforspecificnftsale", "apikey", "nftprojectid"],
    suffix: "Response",
  }),

  // Pricelist operations that exist
  GetPricelistResponse: pickOp({
    includes: ["getpricelist", "apikey", "projectuid"],
    suffix: "Response",
  }),
  GetPricelistNftProjectResponse: pickOp({
    includes: ["getpricelist", "apikey", "nftprojectid"],
    suffix: "Response",
  }),

  // NFT Details operations that exist
  GetNftDetailsResponse: pickOp({
    includes: ["getnftdetails", "apikey", "nftprojectid", "nftname"],
    suffix: "Response",
  }),
  GetNftDetailsByIdNftProjectResponse: pickOp({
    includes: ["getnftdetailsbyid", "apikey", "nftprojectid", "nftid"],
    suffix: "Response",
  }),

  // Additional GetNfts variations that exist
  GetNftsNftProjectResponse: pickOp({
    includes: ["getnfts", "apikey", "nftprojectid", "state", "count", "page"],
    suffix: "Response",
  }),
  GetNftsStateOnlyResponse: pickOp({
    includes: ["getnfts", "apikey", "nftprojectid", "state"],
    suffix: "Response",
  }),

  // Additional GetCounts variations that exist
  GetCountsNftProjectResponse: pickOp({
    includes: ["getcounts", "apikey", "nftprojectid"],
    suffix: "Response",
  }),

  // Additional GetAddressForRandomNftSale variations that exist
  GetAddressForRandomNftSaleNftProjectResponse: pickOp({
    includes: ["getaddressforrandomnftsale", "apikey", "nftprojectid", "countnft"],
    suffix: "Response",
  }),
  GetAddressForRandomNftSaleWithLovelaceResponse: pickOp({
    includes: ["getaddressforrandomnftsale", "apikey", "projectuid", "countnft", "lovelace"],
    suffix: "Response",
  }),
  GetAddressForRandomNftSaleNftProjectWithLovelaceResponse: pickOp({
    includes: ["getaddressforrandomnftsale", "apikey", "nftprojectid", "countnft", "lovelace"],
    suffix: "Response",
  }),

  // Additional GetAddressForSpecificNftSale variations that exist
  GetAddressForSpecificNftSaleNftProjectResponse: pickOp({
    includes: ["getaddressforspecificnftsale", "apikey", "nftprojectid", "nftid", "tokencount"],
    suffix: "Response",
  }),
  GetAddressForSpecificNftSaleWithLovelaceResponse: pickOp({
    includes: ["getaddressforspecificnftsale", "apikey", "nftuid", "tokencount", "lovelace"],
    suffix: "Response",
  }),
  GetAddressForSpecificNftSaleNftProjectWithLovelaceResponse: pickOp({
    includes: [
  ...
  CancelAddressReservationNftProjectResponse: pickOp({
    includes: ["canceladdressreservation", "apikey", "nftprojectid", "paymentaddress"],
    suffix: "Response",
  }),

  // Additional CheckAddress variations that exist
  CheckAddressNftProjectResponse: pickOp({
    includes: ["checkaddress", "apikey", "nftprojectid", "address"],
    suffix: "Response",
  }),

  // Project details variations that exist
  ProjectDetailsCustomerResponse: pickOp({
    includes: ["getprojectdetails", "apikey", "customerid", "nftprojectid"],
    suffix: "Response",
  }),
